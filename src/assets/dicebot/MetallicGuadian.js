...
(function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_MetallicGuadian_gameName_1, TMP_MetallicGuadian_gameType_2;

    
    self.$setPrefixes(["2D6.*", "MG.*"]);
    self.$set_aliases_for_srs_roll("MG");
    
    Opal.defn(self, '$gameName', TMP_MetallicGuadian_gameName_1 = function $$gameName() {
      var self = this;

      return "メタリックガーディアン"
    }, TMP_MetallicGuadian_gameName_1.$$arity = 0);
    return (Opal.defn(self, '$gameType', TMP_MetallicGuadian_gameType_2 = function $$gameType() {
      var self = this;

      return "MetallicGuadian"
    }, TMP_MetallicGuadian_gameType_2.$$arity = 0), nil) && 'gameType';
...
(function(Opal) {
  ...
  self.$require("diceBot/SRS");
  return (function($base, $super, $parent_nesting) {
    var self = $klass($base, $super, 'MetallicGuadian');
    ...
    self.$setPrefixes(["2D6.*", "MG.*"]);
    self.$set_aliases_for_srs_roll("MG");
    Opal.const_set($nesting[0], 'NAME', "\u30E1\u30BF\u30EA\u30C3\u30AF\u30AC\u30FC\u30C7\u30A3\u30A2\u30F3");
    Opal.const_set($nesting[0], 'SORT_KEY', "\u3081\u305F\u308A\u3064\u304F\u304B\u3042\u3066\u3044\u3042\u3093");
    return Opal.const_set($nesting[0], 'ID', "MetallicGuadian");
