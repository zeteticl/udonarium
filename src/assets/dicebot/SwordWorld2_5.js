...
(function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_SwordWorld2_0_initialize_1, TMP_SwordWorld2_0_gameName_2, TMP_SwordWorld2_0_gameType_3, TMP_SwordWorld2_0_getHelpMessage_4, TMP_SwordWorld2_0_rollDiceCommand_5, TMP_SwordWorld2_0_getRateUpFromString_6, TMP_SwordWorld2_0_getAdditionalString_7, TMP_SwordWorld2_0_rollDice_8, TMP_SwordWorld2_0_getGratestFortuneFromString_9, TMP_SwordWorld2_0_is2dCritical_10, TMP_SwordWorld2_0_check2dCritical_11, TMP_SwordWorld2_0_check_nD6_12, TMP_SwordWorld2_0_growth_14, TMP_SwordWorld2_0_growth_step_15, TMP_SwordWorld2_0_get_ability_by_dice_16, TMP_SwordWorld2_0_get_fumble_table_17, TMP_SwordWorld2_0_get_tangle_table_18;
    ...
    Opal.defn(self, '$initialize', TMP_SwordWorld2_0_initialize_1 = function $$initialize() {

      var self = this, $iter = TMP_SwordWorld2_0_initialize_1.$$p, $yield = $iter || nil, rating_table = nil;



      if ($iter) TMP_SwordWorld2_0_initialize_1.$$p = null;

      

      rating_table = 2;

      $send(self, Opal.find_super_dispatcher(self, 'initialize', TMP_SwordWorld2_0_initialize_1, false), [], null);

      return (self.rating_table = rating_table);

    }, TMP_SwordWorld2_0_initialize_1.$$arity = 0);

    

    Opal.defn(self, '$gameName', TMP_SwordWorld2_0_gameName_2 = function $$gameName() {
    ...
    }, TMP_SwordWorld2_0_gameName_2.$$arity = 0);

    

    Opal.defn(self, '$gameType', TMP_SwordWorld2_0_gameType_3 = function $$gameType() {
    ...
    }, TMP_SwordWorld2_0_gameType_3.$$arity = 0);

    

    Opal.defn(self, '$getHelpMessage', TMP_SwordWorld2_0_getHelpMessage_4 = function $$getHelpMessage() {
    ...
    Opal.defn(self, '$rollDiceCommand', TMP_SwordWorld2_0_rollDiceCommand_5 = function $$rollDiceCommand(command) {
      ...
      else {return $send(self, Opal.find_super_dispatcher(self, 'rollDiceCommand', TMP_SwordWorld2_0_rollDiceCommand_5, false), [command], null)}})()
    ...
    Opal.defn(self, '$getAdditionalString', TMP_SwordWorld2_0_getAdditionalString_7 = function $$getAdditionalString(string, output) {

      var $a, $b, self = this, $iter = TMP_SwordWorld2_0_getAdditionalString_7.$$p, $yield = $iter || nil, values = nil, isGratestFortune = nil, $writer = nil;



      if ($iter) TMP_SwordWorld2_0_getAdditionalString_7.$$p = null;

      

      $b = $send(self, Opal.find_super_dispatcher(self, 'getAdditionalString', TMP_SwordWorld2_0_getAdditionalString_7, false), [string, output], null), $a = Opal.to_ary($b), (output = ($a[0] == null ? nil : $a[0])), (values = ($a[1] == null ? nil : $a[1])), $b;
    ...
    }, TMP_SwordWorld2_0_getAdditionalString_7.$$arity = 2);

    

    Opal.defn(self, '$rollDice', TMP_SwordWorld2_0_rollDice_8 = function $$rollDice(values) {

      var $a, $b, self = this, $iter = TMP_SwordWorld2_0_rollDice_8.$$p, $yield = $iter || nil, dice = nil, diceText = nil;



      if ($iter) TMP_SwordWorld2_0_rollDice_8.$$p = null;
      ...
      if ($truthy(values['$[]']("isGratestFortune"))) {
        ...
        return $send(self, Opal.find_super_dispatcher(self, 'rollDice', TMP_SwordWorld2_0_rollDice_8, false), [values], null)
    ...
    }, TMP_SwordWorld2_0_rollDice_8.$$arity = 1);

    

    Opal.defn(self, '$getGratestFortuneFromString', TMP_SwordWorld2_0_getGratestFortuneFromString_9 = function $$getGratestFortuneFromString(string) {
    ...
    }, TMP_SwordWorld2_0_getGratestFortuneFromString_9.$$arity = 1);

    

    Opal.defn(self, '$is2dCritical', TMP_SwordWorld2_0_is2dCritical_10 = function $$is2dCritical() {
    ...
    }, TMP_SwordWorld2_0_is2dCritical_10.$$arity = 0);

    

    Opal.defn(self, '$check2dCritical', TMP_SwordWorld2_0_check2dCritical_11 = function $$check2dCritical(critical, dice_new, dice_arry, loop_count) {
    ...
    }, TMP_SwordWorld2_0_check_nD6_12.$$arity = 8);

    

    Opal.defn(self, '$growth', TMP_SwordWorld2_0_growth_14 = function $$growth(count) {
      ...
      return $send(Opal.Range.$new(1, count, false), 'map', [], (TMP_13 = function(){var self = TMP_13.$$s || this;



      return self.$growth_step()}, TMP_13.$$s = self, TMP_13.$$arity = 0, TMP_13)).$join(" | ")

    }, TMP_SwordWorld2_0_growth_14.$$arity = -1);

    

    Opal.defn(self, '$growth_step', TMP_SwordWorld2_0_growth_step_15 = function $$growth_step() {
    ...
    }, TMP_SwordWorld2_0_growth_step_15.$$arity = 0);

    

    Opal.defn(self, '$get_ability_by_dice', TMP_SwordWorld2_0_get_ability_by_dice_16 = function $$get_ability_by_dice(dice) {
    ...
    }, TMP_SwordWorld2_0_get_ability_by_dice_16.$$arity = 1);

    

    Opal.defn(self, '$get_fumble_table', TMP_SwordWorld2_0_get_fumble_table_17 = function $$get_fumble_table() {
    ...
    }, TMP_SwordWorld2_0_get_fumble_table_17.$$arity = 0);

    return (Opal.defn(self, '$get_tangle_table', TMP_SwordWorld2_0_get_tangle_table_18 = function $$get_tangle_table() {
    ...
    }, TMP_SwordWorld2_0_get_tangle_table_18.$$arity = 0), nil) && 'get_tangle_table';

  })($nesting[0], Opal.const_get_relative($nesting, 'SwordWorld'), $nesting);
...
Opal.loaded(["diceBot/SwordWorld2_0"]);
/* Generated by Opal 0.11.4 */
(function(Opal) {
  function $rb_ge(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs >= rhs : lhs['$>='](rhs);
  ...
  return (function($base, $super, $parent_nesting) {
    function $SwordWorld2_5(){};
    var self = $SwordWorld2_5 = $klass($base, $super, 'SwordWorld2_5', $SwordWorld2_5);

    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_SwordWorld2_5_initialize_1, TMP_SwordWorld2_5_gameName_2, TMP_SwordWorld2_5_gameType_3, TMP_SwordWorld2_5_getHelpMessage_4, TMP_SwordWorld2_5_changeText_5, TMP_SwordWorld2_5_getRatingCommandStrings_7, TMP_SwordWorld2_5_getAdditionalString_8, TMP_SwordWorld2_5_getAdditionalDiceValue_9, TMP_SwordWorld2_5_getKeptDiceChangesFromString_10;

    
    self.$setPrefixes(["K\\d+.*", "Gr(\\d+)?", "FT", "TT"]);
    
    Opal.defn(self, '$initialize', TMP_SwordWorld2_5_initialize_1 = function $$initialize() {
      var self = this, $iter = TMP_SwordWorld2_5_initialize_1.$$p, $yield = $iter || nil, $zuper = nil, $zuper_i = nil, $zuper_ii = nil;

      if ($iter) TMP_SwordWorld2_5_initialize_1.$$p = null;
      // Prepare super implicit arguments
      for($zuper_i = 0, $zuper_ii = arguments.length, $zuper = new Array($zuper_ii); $zuper_i < $zuper_ii; $zuper_i++) {
        $zuper[$zuper_i] = arguments[$zuper_i];
      }
      return $send(self, Opal.find_super_dispatcher(self, 'initialize', TMP_SwordWorld2_5_initialize_1, false), $zuper, $iter)
    }, TMP_SwordWorld2_5_initialize_1.$$arity = 0);
    
    Opal.defn(self, '$gameName', TMP_SwordWorld2_5_gameName_2 = function $$gameName() {
      var self = this;

      return "ソードワールド2.5"
    }, TMP_SwordWorld2_5_gameName_2.$$arity = 0);
    
    Opal.defn(self, '$gameType', TMP_SwordWorld2_5_gameType_3 = function $$gameType() {
      var self = this;

      return "SwordWorld2.5"
    }, TMP_SwordWorld2_5_gameType_3.$$arity = 0);
    
    Opal.defn(self, '$getHelpMessage', TMP_SwordWorld2_5_getHelpMessage_4 = function $$getHelpMessage() {
      var self = this;

      return "" + "自動的成功、成功、失敗、自動的失敗の自動判定を行います。\n" + "\n" + "・レーティング表　(Kx)\n" + "　\"Kキーナンバー+ボーナス\"の形で記入します。\n" + "　ボーナスの部分に「K20+K30」のようにレーティングを取ることは出来ません。\n" + "　また、ボーナスは複数取ることが出来ます。\n" + "　レーティング表も骰子ロールと同様に、他の玩家に隠れてロールすることも可能です。\n" + "　例）K20　　　K10+5　　　k30　　　k10+10　　　Sk10-1　　　k10+5+2\n" + "\n" + "・クリティカル値の設定\n" + "　クリティカル値は\"[クリティカル値]\"で指定します。\n" + "　指定しない場合はクリティカル値10とします。\n" + "　クリティカル処理が必要ないときは13などとしてください。(防御時などの対応)\n" + "　またタイプの軽減化のために末尾に「@クリティカル値」でも処理するようにしました。\n" + "　例）K20[10]　　　K10+5[9]　　　k30[10]　　　k10[9]+10　　　k10-5@9\n" + "\n" + "・骰子目の修正（運命変転やクリティカルレイ用）\n" + "　末尾に「$修正値」で骰子目に修正がかかります。\n" + "　$＋１と修正表記なら骰子目に＋修正、＄９のように固定値なら骰子目をその出目に差し替え。\n" + "　クリティカルした場合でも固定値や修正値の適用は最初の一回だけです。\n" + "　例）K20$+1　　　K10+5$9　　　k10-5@9$+2　　　k10[9]+10$9\n" + "\n" + "・骰子目の修正（必殺攻撃用）\n" + "　「＃修正値」で骰子目に修正がかかります。\n" + "　クリティカルした場合でも修正値の適用は継続されます。\n" + "　例）K20#1　　　k10-5@9#2\n" + "\n" + "・首切り刀用レーティング上昇 r10\n" + "　例）K20r10　K30+24@8R10　K40+24@8$12r10\n" + "\n" + "・グレイテストフォーチュンは末尾に gf\n" + "　例）K20gf　K30+24@8GF　K40+24@8$12r10gf\n" + "\n" + "・超越判定用に2d6ロールに 2D6@10 書式でクリティカル値付与が可能に。\n" + "　例）2D6@10　2D6@10+11>=30\n" + "\n" + "・成長　(Gr)\n" + "　末尾に数字を付加することで、複数回の成長をまとめて行えます。\n" + "　例）Gr3\n" + "\n" + "・防御ファンブル表　(FT)\n" + "　防御ファンブル表を出すことができます。\n" + "\n" + "・絡み効果表　(TT)\n" + "　絡み効果表を出すことができます。\n"
    }, TMP_SwordWorld2_5_getHelpMessage_4.$$arity = 0);
    
    Opal.defn(self, '$changeText', TMP_SwordWorld2_5_changeText_5 = function $$changeText(string) {
      var TMP_6, self = this, $iter = TMP_SwordWorld2_5_changeText_5.$$p, $yield = $iter || nil;

      if ($iter) TMP_SwordWorld2_5_changeText_5.$$p = null;
      ...
      self.$debug("parren_killer_add after string", string);
      return string;
    }, TMP_SwordWorld2_5_changeText_5.$$arity = 1);
    
    Opal.defn(self, '$getRatingCommandStrings', TMP_SwordWorld2_5_getRatingCommandStrings_7 = function $$getRatingCommandStrings() {
      var self = this, $iter = TMP_SwordWorld2_5_getRatingCommandStrings_7.$$p, $yield = $iter || nil, $zuper = nil, $zuper_i = nil, $zuper_ii = nil;

      if ($iter) TMP_SwordWorld2_5_getRatingCommandStrings_7.$$p = null;
      // Prepare super implicit arguments
      for($zuper_i = 0, $zuper_ii = arguments.length, $zuper = new Array($zuper_ii); $zuper_i < $zuper_ii; $zuper_i++) {
        $zuper[$zuper_i] = arguments[$zuper_i];
      }
      return $rb_plus($send(self, Opal.find_super_dispatcher(self, 'getRatingCommandStrings', TMP_SwordWorld2_5_getRatingCommandStrings_7, false), $zuper, $iter), "aA")
    }, TMP_SwordWorld2_5_getRatingCommandStrings_7.$$arity = 0);
    
    Opal.defn(self, '$getAdditionalString', TMP_SwordWorld2_5_getAdditionalString_8 = function $$getAdditionalString(string, output) {
      var $a, $b, self = this, $iter = TMP_SwordWorld2_5_getAdditionalString_8.$$p, $yield = $iter || nil, values = nil, keptDiceChangeModify = nil, $writer = nil;

      if ($iter) TMP_SwordWorld2_5_getAdditionalString_8.$$p = null;
      
      $b = $send(self, Opal.find_super_dispatcher(self, 'getAdditionalString', TMP_SwordWorld2_5_getAdditionalString_8, false), [string, output], null), $a = Opal.to_ary($b), (output = ($a[0] == null ? nil : $a[0])), (values = ($a[1] == null ? nil : $a[1])), $b;
      ...
      return [output, values];
    }, TMP_SwordWorld2_5_getAdditionalString_8.$$arity = 2);
    
    Opal.defn(self, '$getAdditionalDiceValue', TMP_SwordWorld2_5_getAdditionalDiceValue_9 = function $$getAdditionalDiceValue(dice, values) {
  ...
  })($nesting[0], Opal.const_get_relative($nesting, 'SwordWorld2_0'), $nesting);
})(Opal);
