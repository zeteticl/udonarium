...
(function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_FullMetalPanic_gameName_1, TMP_FullMetalPanic_gameType_2;

    
    self.$setPrefixes(["2D6.*", "MG.*", "FP.*"]);
    self.$set_aliases_for_srs_roll("MG", "FP");
    
    Opal.defn(self, '$gameName', TMP_FullMetalPanic_gameName_1 = function $$gameName() {
      var self = this;

      return "フルメタル・パニック！"
    }, TMP_FullMetalPanic_gameName_1.$$arity = 0);
    return (Opal.defn(self, '$gameType', TMP_FullMetalPanic_gameType_2 = function $$gameType() {
      var self = this;

      return "FullMetalPanic"
    }, TMP_FullMetalPanic_gameType_2.$$arity = 0), nil) && 'gameType';
...
(function(Opal) {
  ...
  self.$require("diceBot/SRS");
  return (function($base, $super, $parent_nesting) {
    var self = $klass($base, $super, 'FullMetalPanic');

    var $nesting = [self].concat($parent_nesting);

    
    Opal.const_set($nesting[0], 'ID', "FullMetalPanic");
    Opal.const_set($nesting[0], 'NAME', "\u30D5\u30EB\u30E1\u30BF\u30EB\u30FB\u30D1\u30CB\u30C3\u30AF\uFF01");
    Opal.const_set($nesting[0], 'SORT_KEY', "\u3075\u308B\u3081\u305F\u308B\u306F\u306B\u3064\u304F");
    self.$setPrefixes(["2D6.*", "MG.*", "FP.*"]);
    return self.$set_aliases_for_srs_roll("MG", "FP");
