...
(function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    Opal.def(self, '$getTrapTable', $GurpsFW_getTrapTable$34 = function $$getTrapTable(diff) {
      ...
      dif = nil;
      d = nil;};
      table = ["" + "トライディザスター:宝箱から広範囲に火炎・冷気・電撃が放たれる。PC全員に火炎により" + (["3D", "4D", "5D", "7D"]['$[]'](d)) + "の「叩き」ダメージ、冷気により" + (["3D", "4D", "5D", "7D"]['$[]'](d)) + "の「叩き」ダメージ、電撃により" + (["2D", "3D", "4D", "6D"]) + "の「叩き」ダメージを与える(電撃は金属鎧の防護点無視)", "" + "ペトロブラスター：宝箱を開けた角色に《肉を石》をかける。技能レベルは" + (["20", "22", "24", "30"]['$[]'](d)) + "。", "" + "クロスボウストーム：宝箱から矢の嵐が放たれる罠。PC全員に" + (["2D", "3D", "5D", "8D"]['$[]'](d)) + "の「刺し」ダメージを与える。盾の受動防御を無視した「よけ" + (["", "-2", "-4", "-8"]['$[]'](d)) + "」で回避が可能。", "" + "フォーチュンイーター：PC全員の幸運を食らい、フォーチュンを" + (["1", "2", "3", "5"]['$[]'](d)) + "減少させる。フォーチュンが0の場合" + (["3D", "6D", "9D", "15D"]['$[]'](d)) + "の防護点無視ダメージを受ける。", "" + "スロット：スロットが揃うまで開かない宝箱。スロットを1回まわすには" + (["100", "300", "500", "1000"]['$[]'](d)) + "GPが必要。行動を消費して「視覚" + (["-5", "-7", "-9", "-13"]['$[]'](d)) + "」判定に成功すればスロットはそろう。「反射神経」があれば「視覚」そのままで判定可能。", "" + "テレポーター：宝箱の周囲に存在するPC全員(とエンカウントしている怪獸)をダンジョン入口方面に転送する。深度が" + (["3D減少する", "4D減少する", "5D減少する", "0になる"]['$[]'](d)) + "。", "" + "アイスコフィン：宝箱を開けようとした角色に冷気で" + (["3D", "5D", "7D", "12D"]['$[]'](d)) + "の「叩き」ダメージを与え更に最終的なダメージの半分のFPダメージを与える。", "" + "クロスボウ：宝箱を開けようとした角色に" + (["2D", "3D", "5D", "8D"]['$[]'](d)) + "の「刺し」ダメージを与える。盾の受動防御を無視した「よけ" + (["", "-2", "-4", "-8"]['$[]'](d)) + "」で回避が可能。", "" + "毒針：宝箱を開けようとした角色に" + (["1D", "2D", "3D", "6D"]['$[]'](d)) + "の「刺し」ダメージを与える。1点でもダメージを受けると「生命力" + (["-4", "-5", "-6", "-8"]['$[]'](d)) + "」で判定を行い、失敗すると1日間すべての判定に-2のペナルティを受ける。盾の受動防御を無視した「よけ" + (["", "-2", "-4", "-8"]['$[]'](d)) + "」で回避が可能。", "アラーム：即座にその地形のエンカウント表(イベント表4-1～4-6)を振る。", "" + "殺人鬼の斧：宝箱を開けようとした角色に" + (["3D", "4D", "6D", "10D"]['$[]'](d)) + "の「切り」ダメージを与える。命中部位は「ランダム部位命中表」を用いて決定すること。盾の受動防御を無視した「よけ" + (["", "-2", "-4", "-8"]['$[]'](d)) + "」で回避が可能。", "" + "死神：宝箱を開けようとした角色にネクロマンサーの呪術【憑物】+【死神】の効果を与える。3ラウンドすべての判定に" + (["-1", "-2", "-3", "-4"]['$[]'](d)) + "のペナルティを受け、効果が切れると同時に" + (["3D+3", "3D+6", "3D+9", "3D+15"]['$[]'](d)) + "の防護点無視ダメージを受ける。", "" + "幻の宝：宝箱は二重底になっている。「知力" + (["-5", "-7", "-9", "-13"]['$[]'](d)) + "」か<商人" + (["", "-2", "-4", "-8"]['$[]'](d)) + ">の判定に失敗すると、重さ10kgの価値のない偽の宝物を入手してしまう。偽の宝物はシナリオ終了まで捨てることはできないが「トレジャーイーター」の罠にかかると消滅する。", "" + "エクスプロージョン：宝箱が爆発し、PC全員に" + (["4D", "6D", "9D", "15D"]['$[]'](d)) + "の「叩き」ダメージを与える。宝箱の中身は粉々になる。", "" + "レインボーポイズン：宝箱から七色の毒ガスが放たれる。PC全員が「生命力" + (["-4", "-5", "-6", "-8"]['$[]'](d)) + "」で判定を行い、失敗するとHP、MP、FPに" + (["2D", "3D", "4D", "6D"]['$[]'](d)) + "の防護点無視ダメージを受ける。", "" + "デスクラウド：宝箱から致死性の毒ガスが放たれる。PC全員が「生命力" + (["-4", "-5", "-6", "-8"]['$[]'](d)) + "」で判定を行い、失敗したPCは即座に死亡する。"];
      return [dif, table];
    ...
    Opal.def(self, '$getRandomEvent', $GurpsFW_getRandomEvent$35 = function $$getRandomEvent(dice1, dice2, diff) {
      ...
      area = "洞窟";
      $case = dice2;
      if ((1)['$===']($case)) {table = ["回復の泉。PC全員のHP・MP・FPが完全に回復する。気絶・朦朧状態も回復。", "" + "淡い光を放つ鉱石に包まれた部屋に出る。フォーチュンが" + (self.$getRandomDiff(dice1, 12, d, 0)) + "点回復する。", "" + "天井が開いていて植物の育っている洞窟内庭園。" + (self.$getRandomDiff(dice1, 13, d, 0)) + "に成功すると力の沸く木の実を見つけHP・FP・MPを" + (self.$getRandomDiff(dice1, 13, d, 1)) + "点回復できる。", "洞窟内で栽培できる特殊なキノコを栽培するフラウに出会う。100GP支払うことでキノコを1つ譲ってもらうことができ、シナリオ終了まで《怪力2》《すばやさ2》《知恵2》《活力2》のいずれかの効果を得る(ランダム)このキノコは持ち帰ることはできず、2つめを食べても効果はない。", "ギア技術を用いた強力な懐中電灯のおいてある休憩室。迷宮を出るまで洞窟の深度判定で「暗視」があるものとして扱う。迷宮を出ると懐中電灯は寿命が来たのか壊れてしまう。", "" + "不思議な光を放つ水が沸いている。パーティーメンバーのHP・MP・FPのいずれかが減少している場合このイベントは拒否できない。また、全快でも「好奇心」を持つ角色は知力判定に失敗すると飲みにいこうとする。飲んだ角色は1Dを振り、以下のような効果が発生する。ロールプレイが面白かった場合シナリオ終了時に1CPのボーナスを与えてもよい。\n" + "----------\n" + "1：HP・MP・FP全回復\n" + "2：シナリオ終了まで肉体的に不利な特徴が1つ消滅する\n" + "3：シナリオ終了まで精神的に不利な特徴が1つ消滅する\n" + "4：HP・MP・FPが現在地の半分になる　HPがマイナスの場合はHP・MP・FP全回復\n" + "5：シナリオ終了まで余分な獣っぽい耳や尻尾が生える　聴覚判定+4\n" + "6：シナリオ終了まで性別が男女入れ替わる。\n" + "----------"]}
      else if ((2)['$===']($case)) {table = ["財宝(カギ・トラップなし)。財宝の中身は1段階低い深度の財宝桌面を使用する。", "" + "財宝(カギつき。行動を消費して" + (self.$getRandomDiff(dice1, 22, d, 0)) + "に成功すれば開く)財宝の中身は1段階低い深度の財宝桌面を使用する。", "" + "財宝(カギなし、トラップつき。行動を消費して" + (self.$getRandomDiff(dice1, 23, d, 0)) + "に成功すれば解除可能)財宝の中身は1段階低い深度の財宝桌面を使用する。", "" + "財宝(カギ、トラップつき。行動を消費して" + (self.$getRandomDiff(dice1, 24, d, 0)) + "に成功すれば解除可能)財宝の中身は1段階低い深度の財宝桌面を使用する。", "" + "ミミックの罠。ランダムな角色に3Dの「切り」ダメージを与える。" + (self.$getRandomDiff(dice1, 25, d, 0)) + "に成功すればこの罠を見抜いて無効化することができ、なおかつ「深度×" + (self.$getRandomDiff(dice1, 25, d, 1)) + "」GPを入手可能。", "" + "トレジャーイーターの罠。冒険中に入手したアイテム(消耗品・GP以外)を全て失う。" + (self.$getRandomDiff(dice1, 26, d, 0)) + "に成功すればこの罠を見抜いて無効化することができる。"]}
      else if ((3)['$===']($case)) {table = ["洞窟内で近道を発見。深度が1D+1増加する。", "洞窟内で近道を発見。深度が1D増加する。細い道のため、体の大きな角色(STが13以上)は、通るのに苦労してFPを1点消耗する", "分かれ道。2分の1の確率で深度が1D増加する。「方向感覚」があれば必ず増加。", "" + "足場の悪い近道。PTの誰かが" + (self.$getRandomDiff(dice1, 34, d, 0)) + "に成功すれば深度が1D増加する。失敗した場合は" + (self.$getRandomDiff(dice1, 34, d, 1)) + "の「叩き」ダメージを受ける", "" + "大きな岩でふさがれた近道。1ラウンドで破壊することができれば深度が1D増加する。岩はどのヘクスからでも攻撃可能。分類：岩石、防護点8、" + (self.$getRandomDiff(dice1, 35, d, 0)) + "、切り刺しダメージボーナス無効。", "" + "道が3つに分かれている。1Dで1、2が出るとペナルティなし、1Dで3、4が出ると深度-2、1Dで5、6が出ると深度-4。「直感」があれば、" + (self.$getRandomDiff(dice1, 36, d, 0)) + "の判定に成功すれば正しい道を選択可能。"]}
      else if ((4)['$===']($case)) {table = ["" + (self.$getRandomDiff(dice1, 41, d, 0)) + "とエンカウント。2ラウンド経過するとキャンディークラウンは戦場全域に《べたべた》をかけて逃亡する。", "" + (self.$getRandomDiff(dice1, 42, d, 0)) + "彼らはお互いに争っているがPCたちを見つけると向きを変えて襲い掛かってくる。" + (self.$getRandomDiff(dice1, 42, d, 1)), "" + (self.$getRandomDiff(dice1, 43, d, 0)) + "相手は洞窟では巧妙に擬態しており、【ハイドインシャドウ】状態とみなす。" + (self.$getRandomDiff(dice1, 43, d, 1)), "" + (self.$getRandomDiff(dice1, 44, d, 0)) + "トロッコに乗って逃げつつの戦闘になり、2ラウンド以内に倒せなければ轢かれてPC全員が" + (self.$getRandomDiff(dice1, 44, d, 1)) + "の防護点無視ダメージを受ける。また、1ラウンドに1人誰かが体力判定を行ってトロッコを運転する必要があり、これに失敗すると即座に轢かれてしまう。轢かれると戦闘は終了する。パーテイー内にケイヴウォーカーがいればこの判定は不要。", "" + "炎の燃え盛る洞窟。深度判定直前に炎で" + (self.$getRandomDiff(dice1, 45, d, 0)) + "の「叩き」ダメージを受ける。さらに" + (self.$getRandomDiff(dice1, 45, d, 1)) + "とエンカウント。火炎弱点の怪獸がいれば即座に逃亡する。", "" + "冷気に包まれた洞窟。深度判定直前に冷気で" + (self.$getRandomDiff(dice1, 46, d, 0)) + "のFPダメージを受ける(防護点無視)さらに" + (self.$getRandomDiff(dice1, 46, d, 1)) + "とエンカウント。冷気弱点の怪獸がいれば即座に逃亡する。"]}
      else if ((5)['$===']($case)) {table = ["落盤が怪獸を押しつぶす。戦闘中の場合ランダムな怪獸1人を即死させる。APやドロップ品も入手可能。それ以外の場合は特に何も起きない。", "" + "採掘用のダイナマイトが打ち捨てられている。行動ターンを消費して使用することで任意の半径" + (self.$getRandomDiff(dice1, 52, d, 0)) + "の敵味方全員に" + (self.$getRandomDiff(dice1, 52, d, 1)) + "の「叩き」ダメージを与える。命中判定は自動的に0成功とし、《爆裂火球》と同様にダメージの軽減が可能。", "" + "有毒ガスが発生している。分類「ギア」「アンデッド」以外の角色は敵味方全員" + (self.$getRandomDiff(dice1, 53, d, 0)) + "で判定を行い、失敗度分のダメージを受ける。《空気浄化》などがあれば使用することで無効化できる。", "" + "溶岩の流れる部屋。深度判定直前に炎で" + (self.$getRandomDiff(dice1, 54, d, 0)) + "の「叩き」ダメージを受ける。深度判定を行い、失敗した角色はさらに追加で" + (self.$getRandomDiff(dice1, 54, d, 0)) + "の「叩き」ダメージを受ける。", "" + "落盤がPCのうちランダムに1人を押しつぶす。受動防御無視の" + (self.$getRandomDiff(dice1, 55, d, 0)) + "に失敗すると" + (self.$getRandomDiff(dice1, 55, d, 1)) + "の「叩き」ダメージを受ける。パーティーの誰かが「第六感」か「視覚-5」の判定に成功すれば事前に回避可能。(「暗視」があれば「視覚-2」でも判定可能)", "進んできた道の後方が急に崩落する。ダンジョン攻略が完了するまで「撤退」ができなくなるが、「深度」が現時点より下がることがなくなる。"]}
      else if ((6)['$===']($case)) {table = ["" + "プラネタリウムのように鉱石が輝く部屋。星の配置に関する謎かけになっている。行動を消費して" + (self.$getRandomDiff(dice1, 61, d, 0)) + "に成功すればこの謎を解くことができる。謎が解けると" + (self.$getRandomDiff(dice1, 61, d, 1)) + "が入手できる。", "" + "地熱で温泉が湧いている。このイベントが発生すると怪獸は消滅する。みんなで温泉に浸かることでFPが全回復する。また、温泉の薬効により受けていた毒は無効化され、ラウンドの最初にHPが" + (self.$getRandomDiff(dice1, 62, d, 0)) + "点ずつ回復するようになる。", "" + "地下渓流を発見する。深度判定が体力判定ではなく<水泳>判定になる。深度判定に" + (self.$getRandomDiff(dice1, 63, d, 0)) + "成功以上した場合は地底湖に沈む財宝を発見可能。財宝にカギやトラップはなく、中身は深度そのままの財宝桌面を使用する。", "" + "アダマン鉱脈を発見する。「<採掘>の成功度×深度×" + (self.$getRandomDiff(dice1, 64, d, 0)) + "」GP分のアダマン鉱石を入手可能。複数人数で判定を行えばその回数分入手可能。ただし50GP分ごとに重量が1kg。撤退・全滅した場合アダマン鉱石は消滅する。", "強烈な磁力を放つ鉱石のある部屋。金属製の防具は重量を2倍に計算する。続いてエンカウント表(4-1～4-6)を振ること。なお、4-5の部屋の炎と4-6の部屋の冷気による効果は適用しない。", "" + "怪しい光を放つ鉱石の部屋。鉱石は無生物を破壊する振動を放っており、武器に" + (self.$getRandomDiff(dice1, 66, d, 0)) + "の効果を与える。また、種族「ギア」の角色も同様の効果を受ける。ラウンド終了前に鉱石を破壊すればこの効果は受けない。鉱石はどのヘクスからでも攻撃可能。分類：岩石、防護点8、HP" + (self.$getRandomDiff(dice1, 66, d, 1)) + "、切り刺しダメージボーナス無効。"]}
      else {table = nil};}
      else if ((2)['$===']($case)) {
      area = "遺跡";
      $case = dice2;
      if ((1)['$===']($case)) {table = ["回復の泉。PC全員のHP・MP・FPが完全に回復する。気絶・朦朧状態も回復。", "" + "随分進んだし一休みしよう。深度が奇数の場合はFPが" + (self.$getRandomDiff(dice1, 12, d, 0)) + "回復。深度が偶数の場合は進んだように見せかけて迷っているだけだった。深度が1D減少する。", "" + "どうやらここは古代の医務室らしい。" + (self.$getRandomDiff(dice1, 13, d, 0)) + "に成功すればPC全員のHP・MP・FPが完全に回復する。気絶・朦朧状態も回復。", "「道標のヒカリゴケ」を栽培しているフラウに出会う。300GPを払うと、以後の深度増加判定に+1のボーナスを得る。", "ダンジョンの見取り図を書いた部屋に出る。次のランダムイベントでは、好きな地形を選択してからイベント表を振ることができる。次が最終イベントだった場合、ラウンド終了時の深度判定に+2のボーナスを得る。", "" + "「パワーアップ装置！」と書かれた怪しげな機械が置いてある。" + (self.$getRandomDiff(dice1, 16, d, 0)) + "を支払って使用すると角色を強化(？)可能。使用するかは自由だが、「好奇心」を持つ角色は知力判定に失敗すると使用する。使用した角色は1Dを振り、以下のような効果が発生する。\n" + "----------\n" + "1：能力値が1点上昇する。上がる能力値はランダムで1つ。CP総計はそれに応じて増加する\n" + "2：お肌がピチピチになり、容貌が1段階上昇する。「超美形」の場合さらに反応が男女とも+1(+5CP)\n" + "3：習得している技1つを選択して強化する。ソーサルギアは" + (self.$getRandomDiff(dice1, 16, d, 1)) + "までの魔法を1つ習得する\n" + "4：装置は突然大爆発を起こす！" + (self.$getRandomDiff(dice1, 16, d, 2)) + "の「叩き」ダメージを受ける\n" + "5：「鋭敏感覚1」が身につく。すでに「鋭敏感覚」がある場合そのレベルが上昇する\n" + "6：能力値が1点下降する。下がる能力値はランダムで1つ。CP総計はそれに応じて減少する\n" + "----------"]}
      else if ((2)['$===']($case)) {table = ["財宝(カギ・トラップなし)。財宝の中身は1段階低い深度の財宝桌面を使用する。", "" + "財宝(カギつき。行動を消費して" + (self.$getRandomDiff(dice1, 22, d, 0)) + "に成功すれば開く)財宝の中身は1段階低い深度の財宝桌面を使用する。", "" + "財宝(カギなし、トラップつき。行動を消費して" + (self.$getRandomDiff(dice1, 23, d, 0)) + "に成功すれば解除可能)財宝の中身は1段階低い深度の財宝桌面を使用する。", "" + "財宝(カギ、トラップつき。行動を消費して" + (self.$getRandomDiff(dice1, 24, d, 0)) + "に成功すれば解除可能)財宝の中身は1段階低い深度の財宝桌面を使用する。", "" + "ミミックの罠。ランダムな角色に3Dの「切り」ダメージを与える。" + (self.$getRandomDiff(dice1, 25, d, 0)) + "に成功すればこの罠を見抜いて無効化することができ、なおかつ「深度×" + (self.$getRandomDiff(dice1, 25, d, 1)) + "」GPを入手可能。", "" + "トレジャーイーターの罠。冒険中に入手したアイテム(消耗品・GP以外)を全て失う。" + (self.$getRandomDiff(dice1, 26, d, 0)) + "に成功すればこの罠を見抜いて無効化することができる。"]}
      ...
      else if ((4)['$===']($case)) {table = ["" + (self.$getRandomDiff(dice1, 41, d, 0)) + "とエンカウント。2ラウンド経過するとキャンディークラウンは戦場全域に《べたべた》をかけて逃亡する。", "" + "石像が並ぶ通路がある。1Dを振って1・2・3なら" + (self.$getRandomDiff(dice1, 42, d, 0)) + "。1Dを振って4・5・6・の場合ガーゴイルに似ている、ただの石像。<怪獸知識-5>か「第六感」の判定に成功していなければ必ず相手の先制攻撃になり、その際PC先手で進行中の場合も怪獸先手に変更される。" + (self.$getRandomDiff(dice1, 42, d, 1)), "" + "障害物に隠れて" + (self.$getRandomDiff(dice1, 43, d, 0)) + "が狙撃してくる。怪獸のすぐ傍には合計5ヘクスの障害物(防護点5、HP35。形はGMが任意に決定する)がある。障害物ごしに攻撃するには射撃武器でなくてはならず、射撃武器も命中に-2のペナルティを受ける。", "" + "ブツゼンに怪獸が仁王立ちをしており、問答を行ってくる。" + (self.$getRandomDiff(dice1, 44, d, 0)) + "に成功すると戦闘を回避することができ、APとドロップ品も入手可能。失敗するか戦闘を望んだ場合" + (self.$getRandomDiff(dice1, 44, d, 1)) + "とエンカウントする。", "" + "進路上に鎖に繋がれた怪獸を発見する。迂回して戦闘を避けるなら深度1D減少し、戦闘して倒すと深度が1D増加する。戦闘を行う場合" + (self.$getRandomDiff(dice1, 45, d, 0)) + "とエンカウントする。", "" + "暴れゴーレムが襲いかかってくる！《倍速》の魔法がかかった" + (self.$getRandomDiff(dice1, 46, d, 0)) + "とエンカウントする。このゴーレムは暴走の負荷によりターンの最初にHPが" + (self.$getRandomDiff(dice1, 46, d, 1)) + "減少する。"]}
      else if ((5)['$===']($case)) {table = ["" + "毒矢が飛んでくる。" + (self.$getRandomDiff(dice1, 51, d, 0)) + "に失敗すると" + (self.$getRandomDiff(dice1, 51, d, 1)) + "の「刺し」ダメージを受け、1点でもダメージを受けた場合" + (self.$getRandomDiff(dice1, 51, d, 2)) + "判定を行い失敗すると以後ターンの最初に" + (self.$getRandomDiff(dice1, 51, d, 3)) + "の防護点無視ダメージを受ける。", "" + "毒霧が部屋に散布される。" + (self.$getRandomDiff(dice1, 52, d, 0)) + "で判定を行い、失敗すると《解毒》などを使用しない限り以後の判定全てに-2のペナルティを受ける。《空気浄化》があれば防御タイミングで使用して打ち消すことができる。", "" + "フロアイミテーターだ！この部屋自体が魔物である。ロックバトラー(" + (self.$getRandomDiff(dice1, 53, d, 0)) + ")とエンカウントする。この怪獸がいる限り移動はできず、ラウンドごとの地形変化や深度増加も行わない。PCとフロアイミテーターは常に隣接しているものとして扱う。", "" + "どうやら休憩室のようだ、ふわふわのベッドもある。" + (self.$getRandomDiff(dice1, 54, d, 0)) + "判定に失敗すると転倒状態になり、ダメージを受けるか行動を消費して起こしてもらうまで行動不能。全員失敗した場合、君たちの冒険はここまでだ。せめていい夢を見れるといいだろう(保険は適用可能)", "ラダマンティスの蛇の像と目が合う。どうやらダンジョンの監視者に見つかってしまったらしい！以後怪獸とエンカウントする場合、その数が2倍となる(この効果は累積する)なお、ネームドもしくは魔将の数は変化しない。", "" + "怪しげな卵が1つ置かれている。GMは" + (self.$getRandomDiff(dice1, 56, d, 0)) + "の中から好きなものを1体選びエンカウントさせることができる。深度が0の場合、卵の中から1段階高い財宝桌面のアイテムが手に入る。"]}
      else if ((6)['$===']($case)) {table = ["突如持っていた灯が消えて真っ暗になってしまう。暗闇を見通せる手段(特徴「暗視」、魔法《持続光》、遺跡1-4のヒカリゴケなど)がない限り、PCはこのラウンド中の敏捷力に-4のペナルティを受ける。(ストームコーザーは-8)", "" + "どうやら過去の訓練施設のようだ。「パンチングマシーン」と書かれたものがあり、100GP払って挑戦可能。武器を外した状態での「叩き」ダメージを求め、値が大きいと景品が入手可能。1回挑戦すると、ガタがきていたのか壊れてしまう。＜格闘＞＜猫格闘＞＜空手＞の技を使用しても構わない。\n" + "---------\n" + "ダメージが" + (self.$getRandomDiff(dice1, 62, d, 0)) + "以上：2D×50GP\n" + "ダメージが" + (self.$getRandomDiff(dice1, 62, d, 1)) + "以上：深度が1段階低い財宝桌面\n" + "ダメージが" + (self.$getRandomDiff(dice1, 62, d, 2)) + "以上：深度が1段階高い財宝桌面\n" + "---------", "謎の装置のせいで気になるあの子と体が入れ替わってしまった！？シナリオ終了までPCのうち2人の体が入れ替わってしまい、精神的な特徴と癖が入れ替わってしまう。なぜか知力や技能はそのまま。玩家は入れ替わった相手の性格を演じること。入れ替わる2人はランダムに決定するか面白くなるようにGMが選ぶ。展開が面白かった場合、GMはシナリオクリア時のCPを1点追加しても良い。", "" + "古代のテクノロジーを使用した医療施設だ。このイベントが発生すると怪獸は消滅する。" + (self.$getRandomDiff(dice1, 64, d, 0)) + "に成功すると全員のHP・FP・MPと転倒以外の状態異常を全回復できる。また、シナリオ終了まで不利な肉体的・精神的な特徴を無効化できる。", "" + "キャンディークラウンハウスだ！キャンディークラウン(CL40)×1D" + (self.$getRandomDiff(dice1, 65, d, 0)) + "とエンカウントする。もし1体も倒せなかった場合、1体も倒せずチャンスをものにできなかった悔しさからFPに出てきたキャンディークラウンの数Dのダメージを受ける(軽減不可)", "" + "なぜここに呼ばれたかおわかりになりますでしょうか？ラダマンティス崇拝者の作り出した審判の部屋。<地域知識/フィルトウィズ全域-3>に成功すると罰を与える部屋だとわかり、部屋の中央のラダマンティス像を攻撃できるようになる。像はどのヘクスからでも攻撃可能。分類：岩石、防護点8、HP" + (self.$getRandomDiff(dice1, 66, d, 0)) + "、切り刺しダメージボーナスなし。2ラウンド以内に破壊すれば現在の深度に等しいAPを入手可能。破壊できなかった場合像から裁きの光が放たれ、PC全員が「" + (self.$getRandomDiff(dice1, 66, d, 1)) + "」点の防護点無視ダメージを受ける。"]}
      else {table = nil};}
      else if ((3)['$===']($case)) {
      area = "断崖";
      $case = dice2;
      ...
      else if ((4)['$===']($case)) {table = ["" + (self.$getRandomDiff(dice1, 41, d, 0)) + "とエンカウント。2ラウンド経過するとキャンディークラウンは戦場全域に《べたべた》をかけて逃亡する。", "" + "動物狩りを楽しんでいた魔族と偶然遭遇してしまう。" + (self.$getRandomDiff(dice1, 42, d, 0)) + "とエンカウント。" + (self.$getRandomDiff(dice1, 42, d, 1)) + "には全員《ぼやけ5》がかかった状態。" + (self.$getRandomDiff(dice1, 42, d, 2)) + "減らしておくこと。", "" + "魔族の偵察隊と遭遇する。" + (self.$getRandomDiff(dice1, 43, d, 0)) + "とエンカウント。オウルセージのうち1体は行動ターンに逃亡して他の魔族に警戒を呼び掛けに行く。これを阻止できなかった場合、以後出現する「分類：魔族」の怪獸は物理攻撃の致傷力+" + (self.$getRandomDiff(dice1, 43, d, 1)) + "、防護点+" + (self.$getRandomDiff(dice1, 43, d, 1)) + "のボーナスを得る。", "" + "木々の間を飛び回る何かに背後から突然襲撃される。" + (self.$getRandomDiff(dice1, 44, d, 0)) + "。ペット「スカイサーチャー」か「広視界」がなければ必ず相手の先制攻撃になり、その際PC先手で進行中の場合も怪獸先手に変更される。", "" + "果物を採取する少女達を発見する。しかしよく見ると血塗れの鋏を持つ人形だった！" + (self.$getRandomDiff(dice1, 45, d, 0)) + "とエンカウント。パーティーメンバー全員が" + (self.$getRandomDiff(dice1, 45, d, 1)) + "で判定を行い、成功すれば回避可能。", "" + "前方の森に何か違和感を感じる。周囲に擬態していた" + (self.$getRandomDiff(dice1, 46, d, 0)) + "。「視覚-5」か「第六感」の判定に成功していなければ必ず相手の先制攻撃になり、その際PC先手で進行中の場合も怪獸先手に変更される。判定成功時は深度を1D減少させて戦闘回避も可能。"]}
      else if ((5)['$===']($case)) {table = ["" + "良い香りが周囲に満ちていく。闘争心を失わせるキノコの香りで、戦闘中だった場合敵味方ともに剣を収め強制的に戦闘終了となる。また、以後シナリオ終了まで「平和愛好：専守防衛」の特徴を得る。(意志判定に失敗するとイニシアチブ判定に自動敗北)この効果を受けたくない場合、" + (self.$getRandomDiff(dice1, 51, d, 0)) + "のいずれかの判定に成功する必要がある。この判定には「鋭敏味覚」のレベル分ボーナスを得る。", "" + "美味しそうな果実が生っているのを見つける。意志判定に失敗するとすぐに食べてしまうが(「グルメ」の場合「意志-3」)興奮作用のある実のため頭に血が昇ってしまう。HPとFPが" + (self.$getRandomDiff(dice1, 52, d, 0)) + "回復するが「バーサーク」の特徴を得る。", "" + "巧妙なベアトラップが仕掛けてある。ランダムな角色1人(怪獸も含む)に" + (self.$getRandomDiff(dice1, 53, d, 0)) + "の「切り」ダメージを与える。以後ターンの最初に" + (self.$getRandomDiff(dice1, 53, d, 1)) + "の判定に成功するまで移動不可。本人か隣接した角色が行動を消費して" + (self.$getRandomDiff(dice1, 53, d, 2)) + "で判定することでも解除可能。", "" + "突然のスコールに見舞われる。" + (self.$getRandomDiff(dice1, 54, d, 0)) + "判定を行い、失敗すると体温が奪われFPに" + (self.$getRandomDiff(dice1, 54, d, 1)) + "のダメージを受ける。リザードとワイズマンはこの効果を受けない。<気象学-3>に成功すればあらかじめ雨宿りができ、この効果を受けない。森林イベント3-6の山火事が起きていた場合、その効果は消滅する。", "" + "巨大食虫植物の群生地に足を踏み入れてしまう。" + (self.$getRandomDiff(dice1, 55, d, 0)) + "で判定を行い、失敗するとランダムで1人が植物に飲み込まれてしまう。強酸により" + (self.$getRandomDiff(dice1, 55, d, 1)) + "の「叩き」ダメージを受け、金属でない鎧を装備していた場合1Dで1、2が出ると破壊される。", "" + "すさまじい悪臭を放つ巨大な花。" + (self.$getRandomDiff(dice1, 56, d, 0)) + "判定に失敗した角色はシナリオ終了まで知力が" + (self.$getRandomDiff(dice1, 56, d, 1)) + "点減少する(最大MPは変化しないものとする)また、対応技能が<技師/魔道具>以外のペットは匂いで気絶してシナリオ終了まで効果を得られなくなる。"]}
      else if ((6)['$===']($case)) {table = ["魔族の狩りにより深く傷ついたクレッセントムーンを発見する。<応急処置-7>か<獣医-3>の判定に成功すると、クレッセントムーンの傷は完治し、クレッセントムーン(ペット)を手に入れることができる。", "" + "少し開けた原っぱで、フラウのダンスパーティーに誘われる。このイベントが発生すると怪獸は消滅する" + (self.$getRandomDiff(dice1, 62, d, 0)) + "で判定を行い、成功するとそこにキノコが生え始める。フラウは協力してくれたお礼にこのキノコを分けてくれる。大変貴重な珍味で、持ち帰ると「(1D+成功度)×" + (self.$getRandomDiff(dice1, 62, d, 1)) + "」GPになる。", "" + "フラウたちが「森ガールファッションコンテスト」を開催しており、その助っ人を依頼される。このイベントが発生すると怪獸は消滅する。" + (self.$getRandomDiff(dice1, 63, d, 0)) + "に成功すると自然と一体化したファッションが高評価を受け、お礼に" + (self.$getRandomDiff(dice1, 63, d, 1)) + "(装飾品)を入手できる。", "" + "霊樹の花にたまった水が魔力を帯びている。<神秘学>に成功するとそれにポーションとしての効果があることが分かる。1Dを振り、その出目に対応したポーションが手に入る。\n" + "----------\n" + (self.$getRandomDiff(dice1, 64, d, 0)) + "\n" + "----------", "迷子のフラウを見つける。イベント表で他のフラウに出会った場合そのフラウと知り合いで、お礼に財宝を渡してくれる。財宝の中身は1段階高い深度の財宝桌面を使用する。フラウに出会えずシナリオをクリアした場合も、1段階低い深度の財宝桌面の中身をくれる。", "ランダムに選んだPC1人が、うっかり泉に武器を落としてしまう。すると女神が出て落とした武器と同じ技能で扱うもので、価格が一ランク上のアイテムを落としたのかと聞いてくる。落とした武器と提示してきた武器の差額を1000で割った値をペナルティとして意志判定を行うこと。「守銭奴」はペナルティが2倍になるが、「正直」の場合は自動的に成功になる。成功すると正直に答え提示されたアイテムを両方手に入れることができるが、失敗すると嘘をついて女神を怒らせてしまい、武器を失う。落とした武器が10000GP以上だった場合や、それ以上の武器がアイテムリストになかった場合、自動的にアイテムは返却してもらえる。"]}
      else {table = nil};}
      else if ((6)['$===']($case)) {
      area = "墓地";
      $case = dice2;
      if ((1)['$===']($case)) {table = ["回復の泉。PC全員のHP・MP・FPが完全に回復する。気絶・朦朧状態も回復。", "" + "アズマ風の墓石が佇んでいる。<地域知識/アズマ><地域知識/カベノナカ-4>のいずれかで判定を行う。成功すると正しくお参りを行うことができ、HP、FP、MPの全てが" + (self.$getRandomDiff(dice1, 12, d, 0)) + "回復する。失敗すると霊を怒らせ、全員がFPに" + (self.$getRandomDiff(dice1, 12, d, 1)) + "のダメージを受ける。", "" + "墓守の休憩所を見つける。様々な薬草が置いてあり、行動を消費して<応急処置>を行うことができる。成功すれば" + (self.$getRandomDiff(dice1, 13, d, 0)) + "のHPが回復する。", "ヒガンバナの世話をするフラウと出会う。100GPを払うと「ヒガンバナの毒」を武器に塗ってもらうことができる。最終ダメージに+2の効果があり、武器の通じない「ファントム」のような怪獸にも武器による攻撃が有効になる。この効果はシナリオ終了時まで持続する。", "" + "シルヴァテイルのネクロマンサー達が集まって、何やら怪しい儀式をしている。道中で死亡もしくは保険を適用して強制送還された角色がいれば、" + (self.$getRandomDiff(dice1, 15, d, 0)) + "GPを支払うことで復活させてもらうことができる。それ以外の場合、何か不気味な儀式に不安を感じ、FPを1点消耗する。", "回復の泉があるのだが・・・？パーティーメンバーのHP・MP・FPのいずれかが減少している場合このイベントは拒否できない。HP・MP・FPが完全に回復して気絶や朦朧からも立ち直るが、黄泉の国の水を飲んだことで迷宮から出るまで「分類：アンデッド」となる。回復魔法の効果などは通常の効果があるが、一部の技や魔法で特攻を受ける。《閃光》を受けた際も3Dの防護点無視ダメージを受ける。"]}
      else if ((2)['$===']($case)) {table = ["財宝(カギ・トラップなし)。財宝の中身は1段階低い深度の財宝桌面を使用する。", "" + "財宝(カギつき。行動を消費して" + (self.$getRandomDiff(dice1, 22, d, 0)) + "に成功すれば開く)財宝の中身は1段階低い深度の財宝桌面を使用する。", "" + "財宝(カギなし、トラップつき。行動を消費して" + (self.$getRandomDiff(dice1, 23, d, 0)) + "に成功すれば解除可能)財宝の中身は1段階低い深度の財宝桌面を使用する。", "" + "財宝(カギ、トラップつき。行動を消費して" + (self.$getRandomDiff(dice1, 24, d, 0)) + "に成功すれば解除可能)財宝の中身は1段階低い深度の財宝桌面を使用する。", "" + "ミミックの罠。ランダムな角色に3Dの「切り」ダメージを与える。" + (self.$getRandomDiff(dice1, 25, d, 0)) + "に成功すればこの罠を見抜いて無効化することができ、なおかつ「深度×" + (self.$getRandomDiff(dice1, 25, d, 1)) + "」GPを入手可能。", "" + "トレジャーイーターの罠。冒険中に入手したアイテム(消耗品・GP以外)を全て失う。" + (self.$getRandomDiff(dice1, 26, d, 0)) + "に成功すればこの罠を見抜いて無効化することができる。"]}
      else if ((3)['$===']($case)) {table = ["" + "なにもなさそうな道だが、" + (self.$getRandomDiff(dice1, 31, d, 0)) + "で判定を行う。成功するとちょっとなにかでそうな近道を発見する。深度が2D増加するが、「臆病」な角色は意志判定が必要。", "舗装されていて通りやすい道が続く。深度が1D増加する。途中には祠があり、マジカルクッキングで作った食べ物を持っていた場合、それをお供えすることでHP・MP・FPが全回復する。", "" + "道が途切れ、草が伸び放題の荒れ地に出る。進むには骨が折れそうだ。" + (self.$getRandomDiff(dice1, 33, d, 0)) + "に成功すれば深度+2。失敗するとFPに" + (self.$getRandomDiff(dice1, 33, d, 1)) + "点のダメージを受ける。", "どこまでも卒塔婆とススキしかない・・・同じ景色が続き進んでいるか怪しくなる。2分の1の確率で深度が1D減少する。「方向感覚」があればこの効果は無視できる。", "地面から突如骨の手が伸び移動を邪魔する。全員「移動力+5」を目標値に判定を行い、失敗した角色の人数だけ深度が減少する。【死者に鞭】を持つネクロマンサーがいればこの効果は無視できる。", "" + "先へ進む道には死者の呪いが満ちている。そのまま進むと深度が1D増加するが、以後全ての判定の目標値に" + (self.$getRandomDiff(dice1, 36, d, 0)) + "のペナルティを受ける。遠回りをすると悪影響は受けないが深度が1D減少する。【死者に鞭】を持つネクロマンサーがいれば直進しても悪影響を受けない。"]}
      else if ((4)['$===']($case)) {table = ["" + (self.$getRandomDiff(dice1, 41, d, 0)) + "とエンカウント。2ラウンド経過するとキャンディークラウンは戦場全域に《べたべた》をかけて逃亡する。", "" + "朽ちていた骨が突如起き上がり襲いかかる。" + (self.$getRandomDiff(dice1, 42, d, 0)) + "。「第六感」の判定に成功していなければ必ず相手の先制攻撃になり、その際PC先手で進行中の場合も怪獸先手に変更される。", "" + "不吉な歌を口すざみ、ステップを踏みながらかわいらしい少女が近づいてくる。" + (self.$getRandomDiff(dice1, 43, d, 0)) + "とエンカウント。" + (self.$getRandomDiff(dice1, 43, d, 1)) + "の「華劇」は最初から" + (self.$getRandomDiff(dice1, 43, d, 2)) + "段階進行している。", "" + "遠くから不吉な進軍の音を聞く。PCは全員「聴覚-4」か「第六感」で判定を行うこと。ネクロマンサーは知力判定を行ってもよい。誰か1人でも判定に成功すれば、魔将グレイヴディガーの軍勢が迫っているのを知り、深度を1D減少させてひとまず逃亡することができる。全員判定に失敗してしまうとPCは魔将グレイヴディガー(CL200)とその配下である無数の亡霊騎士団と相対することになる。" + (self.$getRandomDiff(dice1, 44, d, 0)), "" + "貴族の棺とそれを守る人形。" + (self.$getRandomDiff(dice1, 45, d, 0)) + "とエンカウント。棺の中には貴金属が入っており、" + (self.$getRandomDiff(dice1, 45, d, 1)) + "を倒せば「深度×" + (self.$getRandomDiff(dice1, 45, d, 2)) + "」GPを入手可能。", "" + "壁に埋まった10mはあろうかという巨大な蛇の骨が、動き出し襲いかかってくる。" + (self.$getRandomDiff(dice1, 46, d, 0)) + "。"]}
      else if ((5)['$===']($case)) {table = ["" + "PC全員に墓から突然幻影が襲いかかる。" + (self.$getRandomDiff(dice1, 51, d, 0)) + "判定に失敗すると気を取られ「受け」か「止め」を1回消費する。「受け」も「止め」も行えない場合腰を抜かして転倒してしまう。", "" + "ギロチンが突如PCのうちランダムに1人に目掛けて落ちてくる。盾の受動防御を無視した" + (self.$getRandomDiff(dice1, 52, d, 0)) + "に失敗すると" + (self.$getRandomDiff(dice1, 52, d, 1)) + "の「切り」ダメージを受ける。", "" + "用途不明の建物に迷い込む。" + (self.$getRandomDiff(dice1, 53, d, 0)) + "に成功すると、その建物が火葬場であると判明し、すぐに脱出できる。判定に失敗するとPC全員が火炎で" + (self.$getRandomDiff(dice1, 53, d, 1)) + "の「叩き」ダメージを受ける。", "" + "墓石が動き出し中から何かが出てこようとしている。行動を消費して" + (self.$getRandomDiff(dice1, 54, d, 0)) + "で判定を行い、成功すればなにも起こらない。失敗した場合、探索中に倒された怪獸の中で最もCLが高い怪獸と再度エンカウントする(深度判定終了後)該当する怪獸が存在しなかった場合、" + (self.$getRandomDiff(dice1, 54, d, 1)) + "が出現する。", "" + "金の亡者が群がってくる。「2D×" + (self.$getRandomDiff(dice1, 55, d, 0)) + "」GPを払うと支払うと満足して去っていくが、支払を拒否した場合はPC全員が" + (self.$getRandomDiff(dice1, 55, d, 1)) + "の「叩き」ダメージを受ける。【死者に鞭】を持つネクロマンサーがいればこの効果は無視できる。", "ランダムなPC1人の武器が死者の怨念を吸い取り魔剣となる。魔剣は致傷力に+2のボーナスを得るが、所有者は最大HPが5点減少し、不利な特徴「バーサーク」「残忍」を持つようになる。魔剣には「マジックパウダー：無」が常にかかっているものとみなす。魔剣となった武器は売却不可能で、不要な場合捨てるしかない。すでに魔剣になっている武器と、グラントの宝剣は魔剣にはならない。"]}
      else if ((6)['$===']($case)) {table = ["" + "雷が突然鳴り響く。その場にいる全ての角色(怪獸含む)は全員3Dを振り、金属鎧を着ている角色はその値に+3する。この値が一番高い角色は電撃により" + (self.$getRandomDiff(dice1, 61, d, 0)) + "の「叩き」ダメージを受ける(金属鎧の防護点を無視)", "" + "タルの上に腰かけ酒を口に運び続ける、減ることのない酒に向き合うスケルトンがいる。「どうだ、お前らも飲んでいくか？」と声をかけられる。酒を飲む場合、" + (self.$getRandomDiff(dice1, 62, d, 0)) + "判定を4回連続で行うこと。全て成功した場合は、「ついに酒が切れたか、最後の晩酌に付き合ってもらって感謝する」と感謝を述べて財宝を渡してくれる。財宝の中身は1段階高い深度の財宝桌面を使用する。途中で1度でも失敗した場合、酒に悪酔いしてシナリオ終了まで全ての判定に-1のペナルティを受ける。", "" + "妖しい輝きを放つ宝石を発見する。手にとると呪われてシナリオ終了まで全ての判定に" + (self.$getRandomDiff(dice1, 63, d, 0)) + "のペナルティを受ける。手にとらない場合は意志判定に成功しなければならず、「守銭奴」「好奇心」「直情」がある場合意志判定に-3のペナルティを受ける(不利な特徴が複数ある場合修正は累積する)無事持ち帰った場合呪いは解け、" + (self.$getRandomDiff(dice1, 63, d, 1)) + "GPで売却できる", "" + "朽ちたギアの墓場。まだ使えるギアがあるかもしれない。<技師/魔道具>の判定を行い、5成功以上ならアイテムが入手可能。アイテムの内容は1Dで決定する。\n" + "----------\n" + (self.$getRandomDiff(dice1, 64, d, 0)) + "\n" + "----------", "" + "うすら寒い気配の漂う川辺に出る。川辺には渡し守らしき、ローブをかぶった2人の少女がいる。1人あたり" + (self.$getRandomDiff(dice1, 65, d, 0)) + "GPを支払えば深度が1D増加する。支払を拒否した場合は" + (self.$getRandomDiff(dice1, 65, d, 1)) + "。", "" + "『千ノ戦イデ千ノ勝チ方ヲ知ル者、ココニ眠ル』と刻まれた棺を見つける。「好奇心」「直情」の角色は開けずにいるには意志判定が必要。棺を開けた場合は" + (self.$getRandomDiff(dice1, 66, d, 0)) + "。勝利した場合、通常のドロップとは別に" + (self.$getRandomDiff(dice1, 66, d, 1)) + "(《戻る武器》は無し)が必ず手に入る。\n" + "----------\n" + (self.$getRandomDiff(dice1, 66, d, 2)) + "\n" + "----------"]}
      else {table = nil};}
      else {return nil};
