...
import { TextNoteInventoryComponent } from 'component/text-note-inventory/text-note-inventory.component';
  ...
  open(componentName: string) {
    ...
    switch (componentName) {
      ...
      case 'GameObjectInventoryComponent':
        ...
        break;
      case 'TextNoteInventoryComponent':
        component = TextNoteInventoryComponent;
        break;
    }
    if (component) {
