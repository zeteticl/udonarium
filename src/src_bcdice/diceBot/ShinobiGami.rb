  ...
  TABLES = {
    ...
    'MST' => Table.new(
      ...
      [
        ...
        '食堂。染み一つない桌面クロスに覆われた長い食卓。その上は年代物の燭台や花で飾られている。',
        '長い廊下の途中。この屋敷は広すぎて、迷子になってしまいそうだ。',
        '戯れに遊戯室へ入ってみた。そこには撞球台やダーツの的、何組かのトランプが散らばっているポーカー桌面があった。',
    ...
    'NST' => Table.new(
      ...
      [
        ...
        '面白そうなゲーム！　誰かと対戦することになる。GMは、「戦術」からランダムに特技1つを選ぶ。このシーンに登場している角色は、その特技の判定を行う。成功した場合、同じシーンに登場している角色を1人を選び、その角色の自分に対する【感情】を好きなものに変更する（何の【感情】も持っていない場合、好きな【感情】を芽生えさせる）。',
      ]
    ),
    'TKST' => Table.new(
      '東京シーン表',
    ...
    'KWT' => Table.new(
      ...
      [
        ...
        '行方不明:メインフェイズ中、自分以外がシーン玩家のシーンに登場することができなくなる。この効果は累積しない。各サイクルの終了時に、《経済力》で行為判定を行い、成功するとこの変調は無効化される。',
