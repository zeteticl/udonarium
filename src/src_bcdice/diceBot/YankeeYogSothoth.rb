  ...
  @@tables =
    {
      ...
      'BUDT' => {
        ...
        :table => %w{
          ...
          55:隣の玩家のPCが所属する高校と大きな抗争をした。／右隣の玩家のPCに対する【友情度】が1点上昇
          56:修学旅行先で喧嘩し、その後友情を深めた。／【攻撃力】＋１
          66:隣の玩家のPCと一緒に、大きな悪の組織を潰した。／右隣の玩家のPCに対する【友情度】が1点上昇
        },
      },
      ...
      'GUDT' => {
        ...
        :table => %w{
          ...
          55:次に会うヤンキーのために、この世界の土産話を作ってきた。／右隣の玩家のPCに対する【友情度】が1点上昇
          56:悪い魔法使いの儀式を突き止めて、潰した。／【攻撃力】＋１
          66:次に会うヤンキーのために、うまいものを用意した。／右隣の玩家のPCに対する【友情度】が1点上昇
        },
      },
