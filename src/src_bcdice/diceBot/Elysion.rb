...
・新初期アイテム決定表　NA
・授業ハプニング表　JH
・日常遭遇表　NJ1～NJ11／ボス角色遭遇表　BS1～BS11
ファーストオーディション
...
MESSAGETEXT
  ...
  def getDateTable()
    ...
    table = [
      ...
      [13, "「ねぇねぇ知ってる…？」せっかく二人きりなのに、他人の話で盛り上がる。この表の使用者は、PCの中からこの表の使用者以外の角色一人を選び、その角色に対する《感情値》が1点上昇する。"],
  ...
  def getFrindDateTable()
    ...
    table = [
      ...
      [44, "「一緒にご飯を食べよう。」\n二人で同じ桌面を囲んでご飯を食べる。この表の使用者は好きなだけ【お金】を消費する。この表の使用者は《生命力》を[消費した【お金】の合計×1]点回復し、お互いに対する《感情値》が[消費した【お金】の合計+1]点上昇し、属性は《好意》になる。"],
  ...
  def getOnewayDateTable()
    ...
    table = [
      ...
      [12, "「どうしてあの子の話ばかりするのかな？」\nあの人は、いつもそう。私の前であの子の話ばかり。受け身キャラはこの表の使用者以外の角色を一人選ぶ。攻め気キャラは選ばれた角色に対する《感情値》が2点上昇し、属性が《敵意》になる。"],
      [13, "「お仕置き、しないとね。」\n受け身キャラが持っている一番高い《好意》を持っている角色を選ぶ。選ばれた角色は《生命力》を1Ｄ6点減少し、攻め気キャラに対する感情の属性が《敵意》になる。選んだ角色が攻め気キャラだった場合、攻め気キャラの受け身キャラに対する《感情値》が1点上昇し《生命力》が1Ｄ6天回復する。"],
      [14, "「負け犬って何のこと？」\n受け身キャラが持っている中で、一番高い《好意》を持っている角色が攻め気キャラでない場合、攻め気キャラの受け身キャラに対するフラグと、受け身キャラの攻め気キャラに対するフラグを折る。攻め気キャラが最も高い場合攻め気キャラは《アウル》を3点回復する。"],
      ...
      [25, "「どうかこの時間がずっと続きますように。」\n幸せの一瞬。一緒にいるだけでいいのに、時は無情にも過ぎていく。攻め気キャラは《生命力》が限界値まで回復し、《アウル》が2点回復する。ただし、このセッション中に受け身キャラと違う角色とデートを行ったとき、攻め気キャラの《アウル》は0になる。"],
      [26, "「お似合いだなんて、そんな……。」\n一緒に歩いているところを冷やかされる。攻め気キャラは受け身キャラに対する《感情値》が2点上昇し、属性は《好意》になる。受け身キャラは攻め気キャラに対するフラグがあった場合フラグを折る。"],
      [33, "「応援してるよ！」\n本心を隠して、恋や友情の応援！攻め気キャラは、角色を一人選ぶ。受け身キャラは選ばれた角色に対する《感情値》が2点上昇し、属性が《好意》になる。攻め気キャラが受け身キャラに対するフラグがあった場合、フラグを折る。"],
  ...
  def getMidnightDateTable()
    ...
    table = [
      ...
      [33, "「眼が冴えてきたな。」\n目が冴えてきて、夜中でも問題なく動けそうだ。この表の使用者は、このパートの間「真夜中パートに睡眠を行わなかった角色は、そのパート終了時に1Ｄ6点を振って、その目に対応した変調を受けます。」というルールを無効化し、「真夜中デート表」をもう一度振る。"],
  ...
  def getClassRoomBreakTable
    ...
    table = [
      ...
      "誰かの視線\n……誰かの視線を感じる。もしかして？　教室にいる角色の中から好きな者を一人選び、その角色の自分に対する《感情値》が1点上昇する。（教室に誰がいるのかは、最終的にGMが決定すること）。",
      ...
      "お腹空いた\n「ねぇねぇ。お腹空いた。なんかない？」クラスメイトに食事をねだられた。分類が「食物」のアイテムを一つ消費することができたら、教室にいる角色の中から好きな者を一人選び、その角色の自分に対する《感情値》が1点上昇する。",
      "クラスの噂\n「ねぇねぇ、これ知ってる？」クラスメイトの噂話……。〔政治力〕の判定を行う。成功すると、手がかり一つを選び、その情報を公開する。失敗すると、あなたについての噂をたてられる。あなたの周囲に、あなたに対して《感情値》を持つ角色がいたら、それを反転させる。",
      "ラブレター!?\n「こ、これは……ッ!?」机の中に何かを発見。〔青春力〕で判定を行う。成功すると、誰かからのラブレターを発見！ 好きなNPC一人を選び、その角色の自分に対する《感情値》が1点上昇し、属性を《好意》にする。",
  ...
  def getSchoolStoreBrakeTable
    ...
    table = [
      ...
      "購買での出会い\n「……あ」陳列棚の商品に伸ばした手と手が触れあう。購買にいる角色の中から好きな角色の自分に対する《感情値》が1点上昇する（購買に誰がいるのかは、最終的にGMが決定すること）。",
  ...
  def getClubRoomBrakeTable
    ...
    table = [
      ...
      "仲間の告白\n「キミ、最近なんかいい感じだよね」もしも【クラブ】のコミュを修得していたら、部室にいる角色の中から好きな者を一人選び、その角色の自分に対する《感情値》が1点上昇する（部室に誰がいるのかは、最終的にGMが決定する事）",
  ...
  def getStudentCouncilBrakeTable
    ...
    table = [
      ...
      "気になるあいつ\n「不運。そういう名前なのか、あいつ」もしこのシナリオに登場しているＮＰＣで、名前がわからない角色がいたら、それを知ることができる。また、「好きなもの」と「嫌いなもの」が分からない角色がいたら、「単語表」を使ってランダムに決める事ができる。",
      "調べられてる？\n「あれ、これって……？」誰かが自分のことを検索した形跡がある。〔政治力〕で判定を行う。成功すると、自分について調査していた人物を発見！好きなＮＰＣ一人を選び、その角色の自分に対する《感情値》が1点上昇する。",
      "プロフィール更新\n「自分のプロフィールを更新しておこう」〔政治力〕で判定を行う。成功すると、好きな角色一人を選ぶ。その角色の自分に対する《感情値》の属性を《好意》にすることができる。",
      "思わぬ一面\n「へぇ。こいつって、こんなヤツだったんだ」生徒会質で知り合いの思わぬ一面を知る。自分が《感情値》を持っている角色一人を選ぶ。その角色への《感情値》の属性を反転する。",
      "友達検索\n「折角なんで、あいつのこと調べてみるか」友人の情報を検索してみる。〔政治力〕で判定を行う。成功すると、ＰＣの中から好きな角色一人を選ぶ。その角色に対する《感情値》が1点上昇する。",
  ...
  def getDormitoryBrakeTable
    ...
    table = [
      ...
      "思い出の日\n寮の友人とハメを外して、寮長に怒られる。学生寮にいる角色の中から好きな者を一人選ぶ。自分とその角色は「バカ」の変調を受け、お互いに対する《感情値》が2点上昇する（寮に誰がいるのかは、最終的にGMが決定する事）。",
      "引越しの手伝い\n「あ、今日からここに住む者です。よろしく」行きがかり上、引越しの手伝いをすることに。〔青春力〕で判定を行う。成功すると、感謝されてアイテムの【ごちそう】を一つ獲得する。",
      "色々トーク\n友達を自分の部屋に呼んでボーイズトーク！ガールズトーク♪　「青春力」の判定を行う。成功すると、自分に対して《好意》を持っている同姓の角色全員の、自分に対する《感情値》が1点上昇する。判定に失敗するか、自分に対して《好意》を持っている角色が一人もいないと「孤独」の変調を受ける。",
      ...
      "お見舞い\n「ねぇ、大丈夫？」もしも「病気」か「孤独」の変調を受けていたら、友人がお見舞いに来てくれる。好きな角色一人を選ぶ。自分とその角色は、お互いに対する《感情値》が1点上昇する。そして好きな変調一つが回復する。",
      ...
      "寮に潜入\n「こっそり遊びにきてみない？」異性の友人を呼んでスリルを味わう。好きな角色一人を選び、「青春力」で判定を行う。成功すると、自分とその角色は《アウル》が2点回復する。失敗すると、互いに対する《感情値》が1点減少する。",
  ...
  def getLibraryBrakeTable
    ...
    table = [
      ...
      "図書館での出会い\n「……あ」書架の本に伸ばした手と手が触れ合う。図書館にいる角色の中から好きな者を一人選び、その角色の自分に対する《感情値》が1点上昇する（図書館に誰がいるのかは、最終的にGMが決定する事）。",
  ...
  def getRoofBrakeTable
    ...
    table = [
      "風紀委員の巡回！\n「そこ、何やってる！」風紀委員に見つかった。現在が授業パートであれば、こっぴどく叱られる。〔政治力〕で判定を行う。失敗すると、次のパートは行動できない。授業パート以外であれば、心身ともにリフレッシュ。《アウル》が1点回復する。",
      "通り雨\n「キャ〜〜〜〜！」突然雨がふってきた！みんな屋上を去っていく。屋上にいる角色の中から好きな者を一人選び、その角色の自分に対する《感情値》が1点上昇する（屋上に誰がいるのかは、最終的にＧＭが決定すること）。",
      ...
      "物思い\n空をながめながら、物思いにふける。俺ってアイツの事、どう思ってるんだろう？〔青春力〕で判定を行う。成功すると、ＰＣの中から好きな角色一人を選ぶ。その角色に対する、《感情値》が1点上昇する。",
  ...
  def getPoolBrakeTable
    ...
    table = [
      ...
      "新作水着\n新しい水着の評判はどうかな？〔青春力〕の判定を行う。成功すると、プールにいる角色の中から好きな者をその成功度と同じ人数だけ選び、その角色の自分に対する《感情値》が1点上昇する（プールに誰がいるのかは、最終的にＧＭが決定すること）。",
      "ポロリもあるよ\nプールからあがろうとしたき、思わず水着がポロリ。げげ。今の誰か見てたッ!?周囲にいる異性の角色の自分に対する《感情値》の属性が反転する。",
      "熱視線\n誰かが、美しいフォームで飛び込み、水しぶきがあがる。思わず見惚れてしまう。プールにいる角色の中から好きな者を一人選び、自分のその角色に対する《感情値》が1点上昇する（プールに誰がいるのかは、最終的にＧＭが決定すること）。",
      "眼福眼福\n水着がまぶしい!いい眺めかも……。《アウル》が1点回復する。",
      "人魚のように\n華麗なターンが決まり、周囲から賞賛の声があがる。プールにいる角色の中から好きな者を一人を選び、その角色の自分に対する《感情値》が1点上昇する（プールに誰がいるのかは、最終的にＧＭが決定すること）。",
  ...
  def getInnerCourtBrakeTable
    ...
    table = [
      ...
      "突然の告白！\n「先輩、ずっと前から憧れてました！」そう言って、後輩が告白して来た。え？ええッ!?突然の事に頭が真っ白になってしまった。好きな異性の角色一人を選ぶ。その角色の自分に対する《感情値》が2点上昇する。その後、〔青春力〕で判定を行う。失敗すると「バカ」の変調を受ける。",
  ...
  def getDevastationBrakeTable
    ...
    table = [
      ...
      "ライバル登場？\n「一度、お前と手合わせしてみたかったんだよ」撃退士らしき見覚えある人物が現れる。好きなＮＰＣを一人選び、その角色の自分に対する《感情値》が1点上昇する。",
  ...
  def getGateBrakeTable
    ...
    table = [
      ...
      "戦友\n一緒に敵と戦ううちに、絆が芽生えてくる。〔青春力〕で判定を行う。成功すると、ゲートにいる角色の中から好きなものを一人選ぶ。自分とその角色は、お互いに対する《感情値》が1点上昇する（ゲートに誰がいるのかは、最終的にＧＭが決定すること）。失敗すると1D6点のダメージを受ける。",
  ...
  def getBattleFieldTable
    ...
    table = [
      "平地。\n特に特殊効果はない。",
      "罠。\n落とし穴やセキュリティー装置など、無数の罠が仕掛けられた戦場。この戦場にいる角色は、ダメージを受けたとき、速度によるダメージ修整が2倍になる。",
      "障害物。\n林の中や狭い部屋の中など、自由に身動きすることが難しい戦場。この戦場にいる角色は、プロットを行うとき、5以上の速度をプロットできなくなる。",
      "機動戦\n車や電車、船や飛行機など、動いているものの上での戦闘を表す。この戦場にいる角色は、何らかの行為判定にファンブルした場合〔青春力〕で判定を行う。失敗すると、行動済みになり、速度が0になる。",
      "力場。\n展開や魔界の影響を強く受けている戦場。この戦場にいる角色は、ラウンドの終了時に速度0にいると、〔学力〕の判定を行うことができる。成功すると、《アウル》を1点獲得できる。",
  ...
  def getFatalWoundsTable
    name = '致命傷表'
    table = [
      "圧倒的な攻撃が急所をつらぬく。\n行動不能になる。1D6ラウンド後の「ラウンドの終了時」に、まだ戦闘が継続しており、行動不能が回復していなければ、その角色は死亡する。",
  ...
  def getFumbleTable
    ...
    table = [
      ...
      "あまりにも酷い大失敗を見られてしまい、周囲の角色からの評価が変わる。自分の周囲に、自分に対して《感情値》を持つ角色がいたら、それを反転させる。",
      "敵の罠にかかる。自分の周りにいる、自分以外のすべての見方角色は《生命力》を1D6点減少する。",
...
花火\n「たーまやー！」大きな花火があがって、祭りの雰囲気を盛り上げる。真夜中パートだった場合《好意》を持っている角色一人を選ぶ。選んだ角色に対する《感情値》が2点上昇する。真夜中パート以外の場合ゆっくりして《アウル》が1点上昇する。
...
意外な一面\n「あいつ、あんな表情もできたんだ。」お祭りの中で、仲間の意外な一面を知る。PCの中から好きな角色を選ぶ。選んだ角色に対する《感情値》の属性を反転する。
出店！\nクラブやクラスでお店を出すことになった。[青春力]で判定を行う。判定に成功すると、お店は繁盛して【お金】を1個手に入れる。判定に失敗すると、恥ずかしい目に遭って【アウル】が1点減少する。
お祭りの雰囲気\n「ワイワイ、ガヤガヤ。」お祭りだ！つい開放的な気分になって、隣の人を誘ってしまおうかなと思える。好きなPCを一人選ぶ。選んだ角色とデートを行う。このデートは選んだ角色が行動済みでも行え、デートを行っても行動済みにならない。必ず「友達デート表」を使用すること。
対抗レース！\nグラウンドでクラブや委員会を巻き込んだ大レースが始まった！【クラブ】か【委員会】のコミュに所属しているPCは全員、[青春力]で判定を行う。成功すると、《アウル》が1点回復する。さらに、最も達成値が低い角色はMVPとなり、【後輩】を手に入れる。
...
TABLE_TEXT_END
      ...
      'GIT' => {
        ...
        :type => '2d6',
        :table => <<'TABLE_TEXT_END'
「お前たちの血を邪神様の生贄に捧げてやる！」\n世界征服同好会の仕掛けた邪悪で陰湿なトラップにひっかかる。PC全員は《生命力》が2Ｄ6点減少する。このシナリオに登場する世界征服同好会の角色の名前が分かっている場合、その角色に対する《感情値》を1点上昇させ、その属性を《敵意》にする。
「……キミ、よく見るとかわいいね。ちょっとつきあわない？」\n世界征服同好会の一員からデートを申し込まれる。ランダムにPC一人を選ぶ。そのPCは、このシナリオに登場ソウル正解征服同好会の角色一人と、デートを一回行うことができる。（行動済みにはならない。）
...
「ねぇねぇ、あの人って……。」\nPCたちの一人に世界征服同好会の一員であるという嫌疑がかけられる。ランダムにPC一人を選ぶ。そのPCに対して《好意》を持っているPCがいたら、そのPCは[政治力]で判定を行う。失敗するとNPCのその角色に対する《好意》が《敵意》に変わる。
...
「我々のファミリーに近づく者には消えてもらおう。」\n世界征服同好会の仕掛けた周到で悪逆なトラップにひっかかる。PC全員はゲームマスターの選んだ変調を一つ受ける。（PCごとにばらばらの変調を選んでもよい）。このシナリオに登場する世界征服同好会の角色の名前が分かっている場合、その角色に対する《感情値》を1点上昇させ、その属性を《敵意》にする。
TABLE_TEXT_END
      },
...
偶然の出会い\n「あれ？来てたんだ。」知り合いと偶然出会う。好きな角色一人を選び、[青春力]の判定を行う。成功すると、その角色とデートを一度行うことができる。
...
混浴ッッ！？\n湯船に入ってみると、そこには異性の姿が……ええッ！？男湯と女湯間違えたッ！？好きな異性の角色を1人選ぶ。その角色の自分に対する《達成値》が2点上昇する。その後、[青春力]で判定を行う。失敗すると「バカ」の変調を受ける。
TABLE_TEXT_END
      },
...
「な、なんでもないはずなのに！」叱っていたアイツのことが気になってきた……。もっともカオスレートが低い異性の角色に対する《感情値》が2点上昇する。
ネット上で情報について検索していたら、いつの間にかネット上で喧嘩していた。つい熱くなってしまう。「バカ」の変調を受けるが、好きな感情を1つだけ公開することができる。
ありがたい高級なツボを手近にいたPCに売りつける。ランダムに【お金】を持つあなた以外のPCを選ぶ。その角色は【お金】をすべて消費し、【タリスマン】（基本ｐ107）を入手するが、あなたは「孤独」を受ける。【お金】がなかった場合、舌打ちだけする。
...
TABLE_TEXT_END
      ...
      'JH' => {
        ...
        :type => '2d6',
        :table => <<'TABLE_TEXT_END'
授業中に突然テロリストが侵入してくる。「日常遭遇表（ｐ97）」を使ってエネミーを決定する。そのエネミーと、この授業判定を行った角色は戦闘を行う。
もうすこしがんばりましょう。先生からのプレゼント。もし、この授業判定に失敗していたら、この表を使用した角色は【参考書】（基本ｐ107）を一つ獲得する。
居眠りしてたらリフレッシュ！この表を使用した角色は、《生命力》を1Ｄ6点回復する。
先生からお使いを頼まれる。この表を利用した角色は、「図書館」（基本ｐ92）の「図書館休憩表」を使用する。
アウルが暴走して事故発生！この表を使用した角色は《生命力》を1Ｄ6点減少する。
授業中に生徒同士で口論になる。この授業判定を行った角色の中に、この表を使用した角色に対して《好意》を持っていた角色がいたら、その属性を《敵意》にする。
先生から課題をもらう。この表を使用した角色は、次に[学力]で判定に成功するまで、この授業の□にチェックを入れることができない（チェックを入れることができないような場合は、特に効果はない）。
先生は受講態度が気にくわなかったようだ。なぜか廊下に立たされる。この表を使用した角色は、1Ｄ6を振って、ランダムに変調一つを選び、それを受ける。
ちょっとだけ自習になる。この授業判定に参加した角色全員は、「教室」（基本ｐ87）の「教室休憩表」を一度ずつ使用する。
を？こんなところにパンが落ちてる。この表を使用した角色は【焼きそばパン】（基本ｐ106）を一つ獲得する。この【焼きそばパン】を使用した時1Ｄ6を振る。１が出ると、通常の【焼きそばパン】の効果の代わりに《生命力》が1点減少する。
先生はみんなの授業態度に大いに満足したようだ。授業判定の成否や授業レベル、授業の種類に関わらず、授業判定に参加した角色全員は、この曜日の授業の□にチェックを入れる。
TABLE_TEXT_END
      },
...
TABLE_TEXT_END
      ...
      'NT' => {
        ...
        :type => '1d6',
        :table => <<'TABLE_TEXT_END'
「善とか悪とか、全部煩わしくなってきた」カオスレートが+2以上もしくは2以下のPCがいる場合、その角色全てを理由もなく殴りつける。。殴りつけられたPCに2D6点のダメージを与える。この攻撃は成功度を1として扱い、好きな能力値でガード可能。
...
二人で迷子\n「あれれ？こっちの道でよかったのかな？」二人ではぐれてしまう。PCの中から好きな角色を1人選ぶ。自分の選んだ角色に対する《感情値》が1点上昇し、属性が《敵意》になる。
...
枕投げ！\nやっぱり修学旅行といえば枕投げでしょ！PCの中から好きな角色を一人選ぶ。[青春力]で判定を行う。成功すると、その角色は《生命力》が1Ｄ6点減少し、その角色の自分に対する《感情値》が2点上昇する。失敗すると、自分の《生命力》が1Ｄ6点減少し、その角色に対する《感情値》が2点上昇する。
