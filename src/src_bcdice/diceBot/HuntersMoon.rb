...
INFO_MESSAGE_TEXT
  ...
  def hm_city_location_table
    table = [
      ...
      '高速道路/高速道路の路上。全ての角色が、ファンブル時には走ってきた車に跳ねられて1D6のダメージを受ける。',
  ...
  def hm_small_location_table
    table = [
      ...
      '地下鉄/地下鉄の線路上。全ての角色が、ファンブル時にはなぜか走ってくる列車に撥ねられて1D6ダメージを受ける。',
      '地下道/暗いトンネル。車道や照明の落ちた地下街。ハンターは、ファンブル時にアイテムを一つランダムに失くしてしまう。',
      '廃病院/危険な廃物がたくさん落ちているため、誰もここで戦うのは好きではない。角色全員の【モラル】を3点減少してから戦闘を開始する。',
  ...
  def hm_hot_location_table
    table = [
      ...
      '調理場/調理器具があちこちに放置された、アクションには多大なリスクをともなう場所。全ての角色は、ファンブル時に良くない場所に手をついたり刃物のラックをひっくり返して1D6ダメージを受ける。',
      'ボイラー室/モノビーストは蒸気機関の周囲を好む傾向があるが、ここはうるさくて気が散るうえに暑い。全ての角色は、感情属性が「怒り」の場合、全てのアビリティの反動が1増加する。',
      '機関室/何らかの工場。入り組みすぎて周りを見通せないうえ、配置がわからず出たとこ勝負を強いられる。角色全員が戦闘開始時に「妨害」の変調を発動する。',
  ...
  def hm_freezing_location_table
    table = [
      ...
      '墓地/死んだ人々が眠る場所。ここで激しいアクションを行うことは冒涜的だ。全ての角色は感情属性が恐怖の場合、全てのアビリティの反動が１増加する。',
