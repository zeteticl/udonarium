...
INFO_MESSAGE_TEXT
  ...
  def getLinkHappyTable
    table = [
      ...
      '【有能な友人】あなたの友人は、怪獸の存在とあなたの本当の仕事を知っています。そして、直接戦うだけの技量はないものの、あなたの探索をサポートしてくれます。',
      '【愛する恋人】あなたには愛する人がいます。見つめあうだけで、あなたの心は舞い上がり……帰ってきません。この恋人を失うなんて、考えるだけでも恐ろしいことです。',
      '【同志の権力者】あなたには怪獸の存在を知りながら、奴らに屈していない権力者との繋がりがあります。様々な違法行為をはたらく際に、役に立つでしょう。',
...
11:依頼\n《概要》 ハンターは任意の角色に他のハンターの【幸福】を守るように依頼され、その依頼を受ける。\n《目的》 他のハンターの【幸福】のうち一つを結果フェイズまで破壊されないこと。この【幸福】は、ゲームマスターが指定する。\n《報酬》　経験値2
12:防衛\n《概要》 ハンターは今回の敵となる怪獸に【幸福】を狙われている。怪獸を倒さなければ【幸福】を守る事は出来ない。\n《目的》 自分の獲得している【幸福】のうち一つを結果フェイズで失わないこと。この【幸福】はゲームマスターが指定する。\n《報酬》 経験値2
13:復讐\n《概要》 ハンターは今回の敵となる怪獸に負けたことがある。戦闘に敗北したのか、それとも【幸福】を壊されたのか。いずれにせよ、復讐の時だ。\n《目的》 結果フェイズまでに怪獸を無力化すること。\n《報酬》 経験値２
14:関係\n《概要》 ハンターは、特定の人物が参加しているから、という理由で狩りに参加する。憧れているのかライバルなのか、単に仲がいいのかは自由。\n《目的》 結果フェイズの時点で他のハンターのうち一人との関係が、お互いに【深度】3以上になっていること。対象のハンターはシーン玩家が決定する。\n《報酬》 経験値２
15:挑戦\n《概要》 ハンターは今回の敵となる怪獸のことをなんらかの理由で知り、自分から戦いに赴く。\n《目的》 結果フェイズまでハンター全員が生き残り、かつ、フォロワーや怪獸に変化していないこと。\n《報酬》 経験値２
16:救済\n《概要》 ハンターは今回の敵となるフォロワーのうち一人を救うために戦う。\n《目的》 結果フェイズまでに対象のフォロワーを「説得」で無力化する。このフォロワーはシーン玩家が決定する。\n《報酬》 経験値2
22:復調\n 《概要》 ハンターは正気を取り戻し、【狂気】を癒すために戦う。\n《目的》 結果フェイズまでに自分の【狂気】を2減らす。\n《報酬》 経験値２
23:撃滅 \n《概要》 ハンターは狩りの対象である怪獸を倒すために育成されていたり、怪獸に【幸福】を全て破壊された過去を持っている。\n《目的》 怪獸を自分で無力化する。\n《報酬》　経験値6
24:競争 \n《概要》 ハンターは自分で決めたライバルに勝つために狩りを行う。\n《目的》 他の玩家のハンターからライバルを一人選ぶ。結果フェイズの段階で、ライバルよりも多くの怪獸とフォロワーを攻撃で倒している事。このライバルはシーン玩家が選択する。\n《報酬》 経験値6
25:育成 \n《概要》 ハンターは仲間を成長させるために狩りに出る。\n《目的》 他の狩人すべてに導入タイプの目的を達成させる。\n《報酬》 達成した人数+2の経験値
26:窮乏 \n《概要》 ハンターは貧乏なので、金のために狩りをしなければならない。\n《目的》 自分が装備しているアイテムから一つを対象として選ぶ。対象は即座に破壊される。そのうえで、結果フェイズまで対象が書いてあったアイテム欄を使用しない。この対象はシーン玩家が選択する。\n《報酬》 経験値6
33:泰然 \n《概要》 ハンターはクールでかっこいい自分のスタイルを守るために狩りをする。\n《目的》 結果フェイズまで【激情】を使用しない。\n《報酬》 経験値8
34:対話 \n《概要》 ハンターは怪獸と話をするために追いかけていく。\n《目的》 怪獸に対する関係【深度】が2以上になっている状態で決戦フェイズに入る。\n《報酬》 経験値8
35:完勝 \n《概要》 ハンターは今回の敵となる怪獸に勝ったことがある。今度こそ、とどめを刺すのだ。\n《目的》 部位ダメージを受けずに怪獸を無力化する。\n《報酬》 経験値4
36:依頼(ハード) \n《概要》 ハンターは任意の角色に他のハンターの【幸福】を守るように依頼され、その依頼を受ける。\n《目的》 他のハンターの【幸福】を一つも結果フェイズまで破壊されないこと。対象となるハンターは、ゲームマスターが指定する。\n《報酬》 経験値4
44:防衛(ハード) \n《概要》 ハンターは今回の敵となる怪獸に自分の【幸福】を狙われている。怪獸を倒さなければ、【幸福】を守ることはできない。\n《目的》 自分の獲得している【幸福】を一つも結果フェイズで失わないこと。\n《報酬》 経験値4
45:復讐(ハード) \n《概要》 ハンターは今回の敵となる怪獸に負けたことがある。戦闘に敗北したのか、それとも、【幸福】を壊されたのか。いずれにせよ、復讐の時だ。\n《目的》 結果フェイズまでに怪獸とフォロワー全てを攻撃で倒すこと。自分の攻撃でなくてもかまわない。\n《報酬》 経験値6
46:関係(ハード) \n《概要》 ハンターは、特定の人物が参加しているから、という理由で狩りに参加する。憧れているのかライバルなのか、単に仲がいいのかは自由。\n《目的》 結果フェイズの時点で他のハンターのうち一人との関係が、お互いに【深度】５になっていること。対象のハンターはシーン玩家が決定する。\n《報酬》 経験値4
55:挑戦(ハード) \n《概要》 ハンターは今回の敵となる怪獸のことをなんらかの理由で知り、自分から戦いに赴く。\n《目的》 結果フェイズまでハンター全員が一度も無力化されずに生き残り、かつ、フォロワーや怪獸に変化していないこと。\n《報酬》 経験値6
