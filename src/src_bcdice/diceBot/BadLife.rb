...
【書式例】
BAD → 1骰子で達成値を表示。
3BAD10+2-1 → 3骰子で修正+11の達成値を表示。
BL8@15 → 1骰子で修正+8、難易度15の判定。
2BL8C-1F1@15 → 2骰子で修正+8、C値-1、F値+1、難易度15の判定。
GL6@20 → 1骰子で修正+6、難易度20の判定。〈波乱万丈〉の効果。
