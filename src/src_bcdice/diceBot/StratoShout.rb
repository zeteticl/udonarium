...
INFO_MESSAGE_TEXT
  ...
  def rollDiceCommand(command)
    ...
    when 'TENKAI'
      title = 'シーン展開表(P201)'
      table = [
        [11, "絶望: ステップを更に大きくする、あるいはシーン玩家を破滅に追い込むような状況に陥ります。【ディスコード】+2点。"],
        [12, "崩壊: ステップによってシーン玩家の大切なものが崩壊する、あるいは崩壊目前に追い込まれます。【ディスコード】+2点。"],
        [13, "断絶: シーン玩家はステップによって何かと絶縁状態になります。【ディスコード】+2点。"],
        [14, "恐怖: ステップに恐怖するような出来事に遭遇します。【ディスコード】+2点。"],
        [15, "誤解: シーン玩家がステップに関するなんらかの誤解を受けます。【ディスコード】+2点。"],
        [16, "試練: シーン玩家はステップに関連した試練に直面します。【ディスコード】+2点。"],
        [22, "悪心: シーン玩家の心に魔が差し、ステップを不合理に解決しようとします。【ディスコード】+1点。"],
        [23, "束縛: ステップに関わるなんらかに束縛され、自由な行動ができなくなります。【ディスコード】+1点。"],
        [24, "凶兆: ステップについて、悪いことが起きそうな前触れが訪れます。【ディスコード】+1点。"],
        [25, "加速: シーン玩家はステップの解決に追われます。【ディスコード】+1点。"],
        [26, "日常: シーン玩家はのんびりとした日常を送ります。【コンディション】+1点。"],
        [33, "休息: ステップを忘れられるような、穏やかなひとときを過ごします。【コンディション】+1点。"],
        [34, "吉兆: ステップについて、いいことが起きそうな前触れが訪れます。【コンディション】+1点。"],
        [35, "発見: シーン玩家はステップについて何かを発見します。【コンディション】+1点。"],
        [36, "希望: シーン玩家の中に、ステップに対して前向きに取り組む意思が生まれます。【コンディション】+1点。"],
        [44, "成長: ステップを通して、シーン玩家が成長します。【コンディション】+2点。"],
        [45, "愛情: ステップを通して、シーン玩家が愛情に触れます。【コンディション】+2点。"],
