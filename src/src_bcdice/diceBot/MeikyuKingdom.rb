...
INFO_MESSAGE_TEXT
  ...
  def mk_calture_research_table
    get_table_by_2d6([
      ...
      "他のランドおメイカーの噂を聞く。宮廷から好きな角色１人を選び、その角色に対する《好意》＋１",
      ...
      "あなたに熱い視線が注がれているのを感じる。宮廷から好きな角色１人を選び、その角色の自分に対する《好意》＋１",
  ...
  def mk_army_research_table
    get_table_by_2d6([
      ...
      "長老から迷宮の昔話を聞く。このゲーム中、自分のレベル以下の怪獸を倒すと、その怪獸を怪獸の《民》にすることができる。この効果は、そのゲーム中に１度だけ使用できる",
      ...
      "近隣で凶悪な怪獸たちが大量発生していると言う。ゲーム中に「火薬」５個を獲得するたびに《民の声》＋１。終了フェイズの収支報告までに１個も「火薬」を獲得出来ないと、維持費＋１ＭＧ",
  ...
  def mk_talent_break_table
    get_table_by_2d6([
      ...
      "嫌いなものが出てくる夢を見て心寂しくなったところに仲間が来てくれる。好きな宮廷内の角色１人への《好意》＋１",
      "好きなものの夢を見る。シチュエーションを表現し、幸せそうだと感じる玩家が居たら《気力》＋２",
      ...
      "今後の冒険について口角泡を飛ばして議論する。好きな宮廷内の角色１人を選び、そのキャラの自分に対する《敵意》を好きなだけ上昇させる。上昇した《敵意》と等しい値だけ《民の声》が回復する",
  ...
  def mk_charm_break_table
    get_table_by_2d6([
      ...
      "たき火を囲みながら会話を楽しむ。GMの左隣にいる玩家から順番に、自分のPCが《好意》を持っているキャラ１体を選ぶ。選ばれたキャラは《気力》＋１。誰からも選ばれなかったキャラは《気力》－１、ランダムに選んだ宮廷内のキャラへの《敵意》＋１",
      "着替えを覗かれる。宮廷内からランダムに１体選び、（1d6）を振る。奇数なら大声をだしてしまい宮廷全員のそのキャラに対する《敵意》＋１、偶数ならそのキャラとあなたの互いの《好意》＋１",
      "食べ物の匂いにつられた怪獸と遭遇する。ランダムエンカウント表で怪獸を決定する。［魅力/怪獸の中で最も高いレベル+3］の判定に成功した場合、その怪獸たちと取引できる。失敗した場合戦闘に突入する",
  ...
  def mk_search_break_table
    get_table_by_2d6([
      ...
      "一眠りしたら夢の中で…。［探索/11］の判定に成功したら、好きな部屋の怪獸の名前とトラップの数をGMから教えてもらえる",
      "配下が眠りにつき、静寂が訪れると隣の部屋から妙な物音が聞こえてきた。隣接する好きな部屋を選ぶ。［探索/10］の判定に成功すると、その部屋に怪獸がいるかどうか、いる場合は怪獸の種類と数が分かる",
      "一休みしようと持ったら、怪獸の墓場を発見した。好きな素材を１種類えらび、宮廷全員のあなたにたいする《好意》の合計に等しい個数だけその素材を入手する",
  ...
  def mk_valor_break_table
    get_table_by_2d6([
      ...
      "怪物のいた痕跡を発見する。［武勇/11］の判定を行い、成功するとＧＭからこのゲームで遭遇する予定の、まだ種類の分かっていない怪獸を１種類教えてもらえる",
  ...
  def mk_festival_break_table
    get_table_by_2d6([
      ...
      'なんでこんなときに、ダンジョンに行かなきゃいけないんだ！　「あ、電報でーす」このマップの支配者から、お祭りによせて祝辞の電報がやってくる。そうか、おまえのせいかッ!!　マップの支配者の名前が分かり、その角色への《敵意》が1D6点上がる',
      ...
      '雰囲気がいつもと違うせいかな。なんかあの人がステキに見える。好きな角色1人を選ぶ。その角色への《好意》を1点上げる',
      ...
      '「あ、この歌は……」祭囃子がキミの封印されていた怪獸にまつわる過去の記憶を呼び戻す。好きな怪獸1種類を選ぶ。その怪獸全般への《敵意》が1点上がる',
  ...
  def mk_festival_table
    get_table_by_2d6([
      ...
      '星祭。季節のお祭り。冬至や夏至などの祭りや、七夕、お花見、雪祭りなどが含まれる。季節感の少ない迷宮では、殊更にその風情を楽しもうとやたら盛り上がる。宮廷全員、好きな角色1人を選び、その角色に対する《好意》を1点上げる',
      ...
      '鬼祭り。お正月に旧年の悪を正す修正会、豆をまいて福を呼び込む追儺の儀式、怪物に仮装した子供たちが夜の王国をねり歩くハロウィーンなど、悪魔や悪霊を払うお祭り。怪獸除けに行われる。このゲームの間、ランダムエンカウントの戦闘後に使用するお宝表が1段階、高いレベルのものを使用する',
      '舞踏会。最高の音楽と芸術的な食事、そしてとびきりの衣装で臨む社交界の華。身分や素性を隠してパートナーを探す仮面舞踏会も人気は高い。ちなみに仮面舞踏会では、女性の側から男性をダンスに誘うのが礼儀だぞ。宮廷全員、ランダムに角色1人を選び、その角色に対する《好意》を1点上げる',
      '競技会。国をあげて、スポーツや芸術、ゲームなど、さまざまなジャンルの一番を決めるお祭り、大会。オリンピックや料理勝負、歌合戦などがある。ランダムに能力値1つを選び、宮廷全員で難易度15の判定を行う。このとき成功した中で、もっとも達成値が高かった角色は、シナリオ終了後、終了フェイズの探索会議で決定される角色とは別に、勲章を得る',
    ])
  end
  ...
  def mk_kingdom_disaster_table
    get_table_by_2d6([
      ...
      "自国の怪獸が凶暴化する。自国の怪獸の《民》からランダムに１種類選び、そのレベルと等しいだけ《民》が減少する。その後、その種類の怪獸の《民》は全ていなくなる",
      "疫病が大流行する。《民》－（2d6）",
  ...
  def mk_charm_happening_table
    get_table_by_2d6([
      ...
      "宮廷に嫉妬の嵐が巻き起こる。宮廷の中で、あなたに対して愛情を持つ角色の数を数える。このゲームの間、行為判定を行うとき、骰子目の合計がこの値以下なら絶対失敗となる（最低２）",
  ...
  def mk_search_happening_table
    get_table_by_2d6([
      ...
      "あなたを憎む迷宮支配者が賞金をかけた。このゲームの間、怪獸の攻撃やトラップの目標をランダムに決める場合、その目標はかならずあなたになる。（この効果を複数人が受けた場合、その中からランダムで決定する）",
    ])
  end
  ...
  def mk_valor_happening_table
    get_table_by_2d6([
      ...
      "あなたを親の敵と名乗るものたちが現れた。このゲーム中に倒した怪獸からランダムに１種類を選び、その怪獸（1d6）体と戦闘を行う",
  ...
  def mk_kingdom_change_table
    get_table_by_2d6([
      ...
      "冒険の成功を祝う民たちが出迎えてくれる。《民の声》＋２。この結果を出した玩家（以下、当ＰＬ）以外の全員は、今回の冒険を振り返り当PLのPCが《好意》を得るとしたら誰が一番ふさわしいかを協議する。決定したキャラへの当PLのPCの《好意》＋１",
  ...
  def mk_travel_table
    get_table_by_2d6([
      ...
      "怪獸の襲撃を受けた。全員［武勇/9］の判定を行い、失敗したキャラは《ＨＰ》が（1d6）点減少する",
  ...
  def mk_negotiation_table
    get_table_by_2d6([
      ...
      "交渉は決裂した。戦闘を行う",
      "交渉は決裂した。戦闘を行う",
      "生け贄を要求された。怪獸の中で最もレベルが高いもののレベルと同じだけ《配下》を減少させれば友好的になる。ただし、《民の声》－（1d6）。《配下》を減らさなければ戦闘を行う",
      ...
      "「何かいいもの」を要求された。怪獸の中で最もレベルが高いもののレベル以上の価格のアイテムを消費すれば友好的になる。レアアイテムは価格を＋１０して扱う。しなければ戦闘を行う",
      "面白い話を要求された。玩家達は怪獸達が興味を引きそうな話をすること。ＧＭがそれを面白いと判断したら［魅力/9］の判定を行い、成功すれば。友好的になる。さもなければ戦闘を行う",
      "一騎打ちを申し込んできた。宮廷の中から代表を１名選び、怪獸の中で最もレベルの高いものと１対１で戦闘を行う（配置は互いに前列）。勝利すれば友好的になる。敗北すれば、再び交渉するか戦闘するかを決断する。この一騎打ちに外野がスキルやアイテムで干渉すると全員で戦闘になる",
      "運命の出会い。怪獸達の宮廷の代表に対する《好意》＋１、友好的になる",
    ])
  end
  ...
  def mk_combat_fumble_table
    get_table_by_2d6([
      "敵に援軍が現れる。敵軍の中で最もレベルの低い怪獸が（1d6）体増える。怪獸側がこの結果になった場合、好きなＰＣの《配下》＋（1d6）",
      ...
      "アイテムを落とした。自分が装備しているアイテムからランダムに１個選び、破壊する。怪獸側の場合、自分に（1d6）ダメージ",
      "カーネルが活性化する。戦闘系とラップからランダムに１種類選び、それがその場に配置される",
      "空を切った攻撃に絶望する。自分と、自分に対して１点以上《好意》を持ったキャラ全員の《気力》－１。怪獸側の場合、自分に（1d6）ダメージ",
      "武器がすっぽ抜ける。攻撃に使用していたアイテムが破壊される。怪獸側の場合、自分に（1d6）ダメージ。その後、バトルフィールドにいるキャラの中からランダムに１体選び、そのキャラの《ＨＰ》を１点にする",
    ])
  end
  ...
  def mk_treasure1_table
    get_table_by_1d6([
      "何も無し",
      "何も無し",
      "その怪獸の素材欄の中から、好きな素材１個",
      "その怪獸の素材欄の中から、好きな素材２個",
      "その怪獸の素材欄の中から、好きな素材３個",
      "【お弁当】１個",
    ])
  end
  ...
  def mk_treasure2_table
    get_table_by_1d6([
      "その怪獸の素材欄の中から、好きな素材３個",
      "その怪獸の素材欄の中から、好きな素材４個",
      "その怪獸の素材欄の中から、好きな素材５個",
      "ランダムに回復アイテム１個",
  ...
  def mk_treasure3_table
    get_table_by_1d6([
      "その怪獸の素材欄の中から、好きな素材５個",
      "その怪獸の素材欄の中から、好きな素材７個",
      "その怪獸の素材欄の中から、好きな素材１０個",
  ...
  def getAftersearchBreakTable()
    get_table_by_2d6([
      ...
      '「おい、サボるな」と仲間から怒られた。いやいや、こっちは今までマジメにやってましたよ。宮廷の中から好きな角色1人を選ぶ。自分のその角色に対する《敵意》が1点上昇する。',
      '大漁大漁！　色々な素材が見つかる。肉、牙、革、木、鉄の素材（角色卡の上の段の素材）を1個ずつ獲得する。',
      ...
      '何も見つからなかったか、と思っていたら「いつも、ありがとう」と宮廷の仲間から声をかけられた。まぁ、何もない方がいいか。宮廷の中から好きな角色1人を選ぶ。自分のその角色に対する《好意》が1点上昇する。',
      '「さすが！　素晴らしいお手並みだ」鮮やかな捜索に、仲間の見る目が変わる。宮廷の中から好きな角色1人を選ぶ。その角色の自分に対する《好意》が1点上昇する。',
      'よしよし、これはいいものが見つかった。好きな素材を1d6個獲得する。この捜索の判定に【使い魔】を使用していれば、獲得数が1d6個上昇する。',
      '大漁大漁！　色々な素材が見つかる。衣料、魔素、機械、火薬、情報の素材（角色卡の上の段の素材）を1個ずつ獲得する。',
      'うわ！　罠だ。余計なものまで見つけてしまった。宮廷全員は1d6点のダメージを受ける。',
      '「へぇ、こんなヤツだったのか」仲間の意外な一面を見つける。宮廷の中から好きな角色1人を選ぶ。自分のその角色に対する《好意》か《敵意》を1点上昇させ、その属性を好きなものに変更できる。',
    ])
  end
  ...
  def getLoversBreakTable()
    table = [
      ...
      [13, '「でさぁ、あの人のことなんだけど……」せっかく2人きりなのに、他人の話で盛り上がる。この表の使用者は、宮廷の中からこの表の使用者以外の角色1人を選び、その角色に対する《好意》が1点上昇する。'],
      ...
      [22, '「え、もうこんな時間！？」一休みするつもりが、気がつくとかなり時間がたっている。宮廷の未行動角色が全員行動済みになったら、通常の時間の経過に加え、さらに1クォーターが経過する。この表の使用者のお互いに対する《好意》が1点上昇する。また、宮廷のこの表の使用者2人に対する《敵意》が1点上昇する。'],
