  ...
  def rollDiceCommand(command)
    ...
    when 'BWT'
      ...
      table = [
        ...
        [33, "オフ", ''],
        [34, "シーン玩家の角色を活かしたミニドラマが制作される。", 'シーン玩家の修得しているキャラ分野の特技'],
        [35, "海外ロケを行うプロダクション制作の旅番組に出演。今日はどこまで行くんだろうか？", '《海外／出身12》'],
        [36, "プロダクション内の劇場で、シーン玩家の「好きなもの」を使った演劇が始まる。", 'シーン玩家の修得している趣味分野の特技'],
        [44, "オフ", ''],
    ...
    when 'LWT'
      ...
      table = [
        [11, "オフ", ''],
        [12, "パートナー玩家の「身体的特徴」にびびっと来たTV曲からオファーが来る。", 'パートナー玩家が修得している身長分野の特技'],
        ...
        [33, "オフ", ''],
        [34, "パートナー玩家の「好きなもの」が題材のドラマが製作中。オーディションを受けよう。", 'パートナー玩家が修得している属性分野の特技'],
        [35, "パートナー玩家の「嫌いなもの」を題材にしたドラマにオファーが……。", 'パートナー玩家が修得している趣味分野の特技'],
    ...
    when 'TWT'
      ...
      table = [
        [11, "オフ", ''],
        [12, "シアター内でドラマを収録。テーマは、パートナー玩家の「好きなもの」だ。", 'パートナー玩家が修得している属性分野の特技'],
        [13, "シアター内で売り出すCDを制作。テーマは、シーン玩家の「好きなもの」だ。", 'シーン玩家が修得している趣味分野の特技'],
        [14, "シアターの売店に駆り出される。直接お客さんと触れ合うチャンス！", '《笑顔／才能7》'],
        [15, "シアター内でグッズを販売。今の売れ線は何かな？", 'キャラ分野からランダム'],
        [16, "シアター内で握手会を開催！　来てくれたみんなに感謝を。", '《気配り／才能9》'],
        [22, "オフ", ''],
        [23, "今回の劇、シーン玩家の【背景】を元にしたノンフィクションドラマ！", '趣味分野からランダム'],
        ...
        [35, "シアター企画、パートナー玩家は「嫌いなもの」に何回挑戦できるか！", 'パートナー玩家が修得している趣味分野の特技'],
        [36, "シアター企画、シーン玩家対「嫌いなもの」！", 'シーン玩家が修得しているキャラ分野の特技'],
        [44, "オフ", ''],
    ...
    when 'CWT'
      ...
      table = [
        ...
        [24, "メイド喫茶をすることになった。パートナー玩家の「好きなもの」が主なメニューだ。", 'パートナー玩家が修得している趣味分野の特技'],
        [25, "校内のイベントを取材することになった。そこにはパートナー玩家の「嫌いなもの」が……。", 'パートナー玩家が修得しているキャラ分野の特技'],
        [26, "パートナー玩家の「ファッション特徴」を活かした、校内ファッションショー。", 'パートナー玩家が修得している属性分野の特技'],
        [33, "オフ", ''],
        [34, "地元の商店街からお店の手伝いを依頼される。町を盛り上げていこう。", '《ショッピング／趣味8》'],
        [35, "地元のイベントに出演。郷土愛が試される！", 'プロデューサーが出身分野の特技から選ぶ'],
        [36, "パートナー玩家の「身体的特徴」に惹かれた企業からオファーが来た！", '《セクシー／属性4》'],
        [44, "オフ", ''],
        [45, "オフ", ''],
        [46, "オフ", ''],
        [55, "オフ", ''],
    ...
    when 'SU'
      ...
      table = [
        ...
        [13, "夏のパレードのコマーシャル。今回のテーマは、パートナー玩家の「好きなもの」。", 'パートナー玩家が修得している趣味分野の特技'],
        ...
        [46, "夏の旅行番組。夏ならではの、地元の強みを伝えることに。", 'シーン玩家が修得している出身分野の特技'],
        [55, "オフ", ''],
    ...
    when 'NA'
      ...
      table = [
        ...
        [24, "森で鬼ごっこをすることになった。相手の動きを読めば勝てる！", 'パートナー玩家が修得している身長分野の特技'],
        ...
        [44, "オフ", ''],
        [45, "視聴者が喜びそうなここだけの話をパートナー玩家にする。", 'パートナー玩家が修得しているキャラ分野の特技'],
        [46, "些細なことでパートナー玩家と喧嘩になる。どっちが強いか勝負だ！", 'パートナー玩家が修得している才能分野の特技'],
        [55, "オフ", ''],
    ...
    when 'WT'
      ...
      table = [
        ...
        [13, "パートナー玩家の「嫌いなもの」に取材をすることになった。大丈夫かな……？", 'パートナー玩家が修得している趣味分野の特技'],
        [14, "シーン玩家の「好きなもの」に関する番組の仕事だ！　テンション上がるー！", 'シーン玩家が修得している趣味分野の特技'],
        [15, "パートナー玩家の「ファッション特徴」を活かす仕事がやって来た。", 'パートナー玩家が修得している属性分野の特技'],
        [16, "クライアントから、もっとパートナー玩家の「個性特技」を推していこうよ、と提案を受ける。", 'パートナー玩家の個性特技'],
        [22, "オフ", ''],
    ...
    when 'VA'
      ...
      table = [
        ...
        [16, "パートナー玩家の「好きなもの」を題材にした番組コーナーを任された。", 'パートナー玩家の修得している趣味分野の特技'],
        [22, "オフ", ''],
        [23, "街歩き番組に出演。軽快なトークで、素人の人たちからうまい言葉を引き出そう。", '《軟派／キャラ5》'],
        [24, "釣り番組に出ることになったが、大物を釣るまで帰れないという。さて、動きの少ない釣りでどうやって目立つか……。", '《キャラ分野の空白／キャラ7》'],
        [25, "パートナー玩家の「嫌いなもの」を題材にした番組コーナーで、いじり役を任されることになった。", 'パートナー玩家の修得しているキャラ分野の特技'],
    ...
    when 'MU'
      ...
      table = [
        [11, "オフ", ''],
        [12, "シーン玩家とパートナー玩家でミニライブをすることになった。うまく声を合わせよう。", 'パートナー玩家の修得している属性分野の特技'],
        [13, "歌番組で取り上げられる。どんな気持ちで歌ったのか、うまく表現して伝えよう。", '《パッション／属性8》'],
        [14, "パートナー玩家とハーモニーを重ねる歌がやってきた。二人の特徴をうまく声に乗せよう。", 'パートナー玩家の修得している才能分野の特技'],
        [15, "CDの手渡し販売が開始。心を込めて、笑顔で手渡しだ。", '《笑顔／才能7》'],
        [16, "レコーディングに音楽業界の大物が立ち会う。緊張せず、自分の実力を発揮しよう。", '《胆力／才能5》'],
        [22, "オフ", ''],
        [23, "パートナー玩家と話し合って歌詞を作ることになった。お互いのことをよく理解しよう。", 'パートナー玩家の修得しているキャラ分野の特技'],
        ...
        [44, "オフ", ''],
        [45, "パートナー玩家の地元を象徴するような歌を作ることになった。地元の話を聞き出そう。", 'パートナー玩家の修得している出身分野の特技'],
    ...
    when 'DR'
      ...
      table = [
        ...
        [36, "パートナー玩家の【背景】を再現したミニドラマを撮るようだ。彼の過去をどう表現したものか。", 'パートナー玩家の修得している属性分野の特技'],
        [44, "オフ", ''],
    ...
    when 'VI'
      ...
      table = [
        ...
        [16, "雑誌でシーン玩家おすすめコーデを紹介するようだ。どんな組み合わせを街に発信しようか。", '《おしゃれ／趣味5》'],
        [22, "オフ", ''],
        [23, "パートナー玩家の「身体的特徴」がちょっとした流行になった。乗るしかない、このビッグウェーブに。", 'パートナー玩家が修得している身長分野の特技'],
        [24, "深夜番組の1コーナーに、シーン玩家の「身体的特徴」の特集が組まれるようだ。それに乗っかろう。", 'シーン玩家が修得している身長分野の特技'],
        [25, "ニュース番組の1コーナーで、パートナー玩家の「ファッション特徴」が紹介される。うまくアシストしよう。", 'パートナー玩家が修得している身長分野の特技'],
        [26, "シーン玩家の「ファッション特徴」を売っている企業から、CMに出てくれないかと頼まれる。", 'シーン玩家が修得している属性分野の特技'],
        [33, "オフ", ''],
        ...
        [55, "オフ", ''],
        [56, "パートナー玩家を宣材用の撮影向けにコーディネートすることになった。さて、どうしてやろうか。", 'パートナー玩家が修得している身長分野の特技'],
        [66, "オフ", ''],
      ]
      return textFromD66Table(title, table)
    ...
    when 'SP'
      ...
      table = [
        ...
        [24, "野球の始球式をすることになった。自分らしく、角色を前面に出して投げるのがコツ。", '《キャラ分野の空白／キャラ7》'],
        ...
        [45, "運動靴のCM。パートナー玩家を力強く追い抜いて、速くなれることをアピール！", '《バーニング／属性10》'],
        [46, "ジャージや体操服のCMが入ってきた。うまく着こなして、運動着もおしゃれなことを証明しよう。", '《おしゃれ／趣味5》'],
        [55, "近々開催される大会の応援団長を任された。出場する選手たちにエールを送ろう！", '《元気／キャラ8》'],
        [56, "テニスの試合をパートナー玩家とやることになった。ダブルスでいこう。", 'パートナー玩家が修得している属性分野の特技'],
    ...
    when 'CHR'
      ...
      table = [
        ...
        [33, "クリスマスに放映される特別ドラマにパートナー玩家の恋人役で出演。恋愛をうまく演じられるかな？", '《演技力／才能12》'],
    ...
    when 'PAR'
      ...
      table = [
        ...
        [15, "オフ", ''],
        [16, "オフ", ''],
        [22, "パートナー玩家の【背景】に関する仕事がやって来る。こいつは何を見てきたんだ？", 'パートナー玩家の個性特技'],
        [23, "パートナー玩家の「好きなもの」に関する仕事がやって来る。場を盛り上げていこう。", 'パートナー玩家が修得している趣味分野の特技'],
        [24, "パートナー玩家の「嫌いなもの」に関する仕事がやって来る。どうフォローしたものか。", 'パートナー玩家が修得しているキャラ分野の特技'],
        [25, "パートナー玩家の「身体的特徴」に関する仕事がやって来る。どこがいいのかを聞いてみる。", 'パートナー玩家が修得している属性分野の特技'],
        [26, "パートナー玩家の「ファッション特徴」に関する仕事がやって来る。自分も真似をすることに。", 'パートナー玩家が修得している身長分野の特技'],
        [33, "パートナー玩家の個性特技に関する仕事がやって来る。合わせてみよう。", 'パートナー玩家の個性特技'],
        [34, "パートナー玩家の「身体的特徴」に関する仕事がやって来る。どこがいいのかを聞いてみる。", 'パートナー玩家が修得している属性分野の特技'],
        [35, "パートナー玩家が修得している属性分野の特技に関する仕事がやって来る。", 'パートナー玩家が修得している属性分野の特技'],
        [36, "パートナー玩家が修得しているキャラ分野の特技に関する仕事がやって来る。", 'パートナー玩家が修得しているキャラ分野の特技'],
        [44, "シーン玩家の【背景】を振り返らせるような仕事がやって来た。今はアイドルとしてそれをこなそう。", 'シーン玩家の個性特技'],
        [45, "パートナー玩家が修得している趣味分野の特技に関する仕事がやって来る。", 'パートナー玩家が修得している趣味分野の特技'],
        [46, "パートナー玩家が修得している出身分野の特技に関する仕事がやって来る。", 'パートナー玩家が修得している出身分野の特技'],
        [55, "シーン玩家の個性特技に関する仕事がやって来る。今こそ見せ場だ！", 'シーン玩家の個性特技'],
        [56, "パートナー玩家が修得している才能分野の特技に関する仕事がやって来る。", 'パートナー玩家が修得している才能分野の特技'],
        [66, "シーン玩家の「好きなもの」に関する仕事がやって来る。やったぜ！", 'シーン玩家の個性特技'],
      ]
      return textFromD66Table(title, table)
    ...
    when 'HA'
      ...
      table = [
        ...
        [15, "ハプニングなし", ''],
        [16, "ハプニングなし", ''],
        [22, "パートナー玩家に、地方からオファーが来た。その土地独特の文化を学んで、パートナー玩家に伝えよう。", 'AT6'],
        [23, "グラビア撮影だが、用意された衣装のサイズがパートナー玩家に合わなかった。何とかして、衣装を合わせなければいけない。", 'パートナー玩家が修得している身長分野の特技'],
        [24, "ダンス撮影中。パートナー玩家のダンスに迷いが見えた。何かアドバイスをして、迷いを取り払いたい。", '《ダンス／趣味9》'],
        [25, "歌の仕事だが、パートナー玩家の歌がどこかぎこちない。うまく本来の歌を取り戻させよう。", 'パートナー玩家が修得している属性分野の特技'],
        [26, "体力を消費する仕事の最中に、パートナー玩家が倒れてしまった！　急いで処置をしなければ！", '《気配り／才能9》'],
        [33, "パートナー玩家にマイナースポーツのCMが回ってきたが、知らない様子だ。ルールを教えよう。", '《スポーツ／趣味4》'],
        [34, "パートナー玩家のキャラに合わない仕事が舞い込んだ。演技力で乗り切ってほしい。", '《演技力／才能12》'],
        [35, "パートナー玩家が風邪をひいてしまう。次の仕事までに、なんとか治してもらわなければ。", '《元気／キャラ8》'],
        [36, "パートナー玩家の属性らしくない衣装が来てしまった。うまくアレンジできればいいけど。", '《おしゃれ／趣味5》'],
        [44, "パートナー玩家のテンションが低い。テンションを上げるようなことを言おう。", '《バーニング／属性10》'],
        [45, "パートナー玩家の仕事に必要な小道具が足りなくなった。調達しよう。", '《ショッピング／趣味8》'],
        [46, "パートナー玩家に外国から仕事が舞い込んできた。外国の文化に合わせた仕事をしなければ。", '《異国文化／才能2》'],
        [55, "パートナー玩家に大会社からの仕事のオファーがやって来る。プレッシャーに負けないように後押ししよう。", '《胆力／才能5》'],
        [56, "パートナー玩家と他のアイドルグループとのコラボイベントが行われる。そのアイドルの情報を集めてこよう。", '《アイドル／趣味12》'],
        [66, "パートナー玩家の周りで、幽霊騒ぎが起こる。安心させるためにも、調査に乗り出そう。", '《オカルト／趣味2》'],
      ]
      return textFromD66Table(title, table)
    ...
    when 'SGT'
      ...
      table = [
        "シーン玩家が修得している才能分野の特技が指定特技のアイドルスキル",
        "シーン玩家が修得しているキャラ分野の特技が指定特技のアイドルスキル",
        "シーン玩家が修得している趣味分野の特技が指定特技のアイドルスキル",
    ...
    when 'RS'
      ...
      table = [
        "シーン玩家が修得している属性分野の特技が指定特技のアイドルスキル",
        "シーン玩家が修得しているキャラ分野の特技が指定特技のアイドルスキル",
        "シーン玩家が修得している趣味分野の特技が指定特技のアイドルスキル",
    ...
    when 'MO'
      title = '山散策表'
      table = [
        [11, "山で迷っていたら、謎の仙人に助けられる。そのついでに、体をうまく動かす方法まで教わる。ありがとう！　謎の仙人！\nシーン玩家とパートナー玩家の【合宿ポイント】が10点上昇する。"],
        [12, "山の幸を頂いて、幸福感に包まれる。うまい！\nシーン玩家とパートナー玩家の【メンタル】が5点上昇する。"],
        [13, "星空の下で、二人の【背景】を語り合う。\nシーン玩家とパートナー玩家のお互いに対する【理解度】が3点上昇する。"],
        [14, "森林浴をして、体調を整える。\nシーン玩家とパートナー玩家の【メンタル】が3点上昇し、変調がすべて回復する。"],
        [15, "山登りを繰り返して、足腰を鍛える。\nシーン玩家とパートナー玩家の【フィジカル】が1点上昇する。"],
        ...
        [26, "山奥にある神社まで登って、お祈りをする。無事にライブが成功しますように。\nシーン玩家とパートナー玩家の【合宿ポイント】が5点上昇する。"],
        [33, "虫にたかられて、嫌な思いをする。\n変調がランダムに一つ発生する。"],
        [34, "仲間たちみんなとバーベキューをして楽しむ。\nシーン玩家とパートナー玩家は、PC全員に対する【理解度】が3点上昇する。"],
        [35, "キノコ狩りをする。\nシーン玩家とパートナー玩家は、1D6を振る。その値が偶数だった場合、アイテム「スタミナドリンク」を一つ獲得する。奇数だった場合、【メンタル】が6点減少する。"],
        [36, "避暑地の喫茶店で一杯飲みながら、お互いのアイドル論について語り合う。\nシーン玩家とパートナー玩家のお互いに対する【理解度】が3点上昇する。"],
        [44, "山を移動中に、落し物をしてしまう。\nシーン玩家とパートナー玩家は、アイテムを一つ失う。"],
    ...
    when 'SPA'
      ...
      table = [
        ...
        [16, "浴衣で活気のある街並みを歩きながら、お互いの【背景】を語り合う。\nシーン玩家とパートナー玩家のお互いに対する【理解度】が1D6点上昇する。"],
        [22, "湯に浸かり過ぎて目が回る。\nシーン玩家とパートナー玩家の【メンタル】が3点上昇し、変調がランダムに一つ発生する。"],
        [23, "たくさんの温泉に次々浸かる。楽しいけど疲れた。\nシーン玩家とパートナー玩家の【メンタル】が5点上昇する。"],
        [24, "湯船に浸かってリフレッシュ。ひとまずは一息入れましょう。\n変調がすべて回復し、シーン玩家とパートナー玩家の【メンタル】が5点上昇する。"],
    ...
    when 'TN'
      ...
      table = [
        ...
        ["夜の街を歩きながら、【背景】をぽつぽつと語り出す。", 'シーン玩家の個性特技'],
        ["「好きなもの」を探しに出かけた帰り道。", 'シーン玩家が修得している趣味分野の特技'],
        ["「嫌いなもの」から逃げてきて、二人きりになってしまった。", 'AT'],
        ["暗い道を往くとき、ふとしたきっかけで、「身体的特徴」に触れてしまう。", 'シーン玩家が修得している身長分野の特技'],
        ["「ファッション特徴」の話に夢中になっていたら、いつの間にか二人になっていたことに気づく。", 'シーン玩家が修得している属性分野の特技'],
      ]
      number, = roll(1, 6)
    ...
    when 'RU'
      ...
      table = [
        ...
        "マスコット角色から聞こえてはいけない音が聞こえてきて、次の瞬間には動かなくなってしまった。\nこのセッションの間、マスコット角色が使用できなくなる。",
        "マスコット角色が行方不明！　プロデューサーが代わりに着ぐるみを着たけれども、負担が大きかった。\n変調「怪我」が発生する。",
        "マスコット角色が不適切な発言をしてしまい、連帯責任で謝罪することになってしまう。\nPC全員の【獲得ファン人数】が、それぞれ5点減少する。",
        "マスコット角色が転んで起き上がれなくなってしまった！　みんなで力を合わせて助け起こそう。\nPC全員の【メンタル】が3点減少する。",
  ...
  def costume(title, brandOnly = false)
    ...
    if title.include?('チャレンジガールズ')
      table = [
        ...
        [25, "Final Romance\n【ビジュアル】のパフォーマンスを行うとき、角色を1人選ぶ。選んだ角色の自分に対する【理解度】と同じだけ、【パフォーマンス値】が上昇する。"],
      ...
      table = [
        ...
        [13, "ロードトゥプリンス\nミラクル、ミラクルシンクロ、パーフェクトミラクルが発生したとき、その角色は【メンタル】が10点上昇する。"],
        [14, "Princess Guardian\n自分以外の角色の【メンタル】が0点になったときに、《気配り／才能9》で判定を行うことができる。この判定には、個性特技は使用できない。成功すると、その角色は、【獲得ファン人数】が半分にならない。"],
        ...
        [23, "Chime\nミラクル、ミラクルシンクロ、パーフェクトミラクルが発生したとき、その角色はランダムにアイテムを1つ獲得する。"],
        [24, "砂上の光\nシンフォニーを行ったとき、シンフォニーを受けた角色の【メンタル】が5点上昇する。"],
      ...
      table = [
        ...
        [14, "Blood Scissors\n自分以外の角色一人の【メンタル】を5点減少するか、プロデューサーに変調「怪我」を与えることで、自分の【メンタル】が5点上昇する。この効果は、プロデューサーが既に「怪我」の変調を受けていると、使用できない。"],
        [15, "蒸気式演技服\n判定を行うとき、【メンタル】を1点消費することで、判定の達成値が1点上昇する。"],
        [16, "ウェイトスター\n「スタミナドリンク」によって、他の角色の【メンタル】を上昇する場合、さらに4点上昇する。"],
        ...
        [33, "Papillon Club\n自分以外の角色がタイプが「補助」のアイドルスキルを使用するたびに、【メンタル】が3点上昇する。"],
        ...
        [46, "ふわふわキッチン\n好きなときに、「お菓子」を一つ消費することで、好きな角色の【メンタル】が1D6点上昇できる。また、幕間に「お菓子」を1つ獲得する。"],
        [55, "Night Talk\n幕間で「信用」を行ったとき、上昇する【メンタル】が10点になる。"],
        [56, "ティーチングタイム\n自分以外の角色を1人指定する。このライブフェイズの間、指定されたPCの能力値が1点上昇する。"],
